...
*The contributions for this section are contained in [this file](./D6.3-catalogue/catalogue-section.md "D6.3 Catalogue Performance Evaluation Section").  Referenced figures are stored aside the contribution file. (Please see the corresponding [Readme[(./D6.3-catalogue/README.md).)*
