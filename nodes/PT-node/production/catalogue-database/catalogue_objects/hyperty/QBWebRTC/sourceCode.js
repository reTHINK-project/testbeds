...
var _stunTurnserverConfig = __webpack_require__(5);
...
var _IdentityManager = __webpack_require__(7);
...
var QBWebRTC = function (_EventEmitter) {
  _inherits(QBWebRTC, _EventEmitter);

  // extends EventEmitter because we need to recieve events

  function QBWebRTC(hypertyURL, bus, configuration) {
    _classCallCheck(this, QBWebRTC);
    ...
    var _this = _possibleConstructorReturn(this, (QBWebRTC.__proto__ || Object.getPrototypeOf(QBWebRTC)).call(this));
    ...
    _this._initProStub(bus, hypertyURL);
    return _this;
  }

  _createClass(QBWebRTC, [{
    key: '_initProStub',
    value: function _initProStub(bus, hypertyURL) {
      //TODO: temporal fix
      var msg = {
      ...
      bus.postMessage(msg, function (reply) {});
    }
  }, {
    key: '_onNotification',
    ...
    value: function createPC() {
      ...
      this.pc.onaddstream = function (obj) {
        console.log('[QBWebRTC]: >>>onaddstream', _this6.pc);
