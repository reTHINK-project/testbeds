...
var _urijs = __webpack_require__(4);

var _urijs2 = _interopRequireDefault(_urijs);

var _Discovery = __webpack_require__(7);

var _Discovery2 = _interopRequireDefault(_Discovery);

var _Syncher = __webpack_require__(8);
...
var SurveyReporter = {
    _getHyFor: function _getHyFor(participants) {
        ...
        return Promise.all(participants.map(function (p) {
            return _this.hypertyDiscoveryService.discoverHyperties(p.email, ['comm'], ['survey'], p.domain).then(function (hyperties) {
    ...
    create: function create(survey, participants) {
        ...
        return this._getHyFor(participants).then(function (hyperties) {
            return _this2.createFromHyperties(survey, hyperties);
        });
    },
    createFromHyperties: function createFromHyperties(survey, hyperties) {
        return this._createSyncher(hyperties).then(function (dataObjectReporter) {
