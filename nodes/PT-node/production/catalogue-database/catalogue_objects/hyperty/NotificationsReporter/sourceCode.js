...
var _notificationsTrigger = __webpack_require__(9);
...
var NotificationsTriggerObject = {
    _getHyFor: function _getHyFor(profiles) {
        var _this = this;
        ...
        return Promise.all(profiles.map(function (p) {
            ...
            //console.log(path)
            return _this._discoveryService.discoverHyperty(p.userURL).then(function (hyperties) {
    ...
    trigger: function trigger(recipients, notification) {
        ...
        return this._getHyFor(recipients).then(function (hypertyURLs) {
            return _this2._syncher.create(_this2._objectDescURL, hypertyURLs, {
                children: [],
                status: 'open',
                participants: hypertyURLs
            }, true, false, 'NotificationReporter', {}, { resources: ['notification'] }).then(function (reporter) {
                reporter.onSubscription(function (event) {
                    return event.accept();
                });
                setTimeout(function () {
                    return reporter.addChild('resources', notification).then(function (child) {
