...
var _urijs = __webpack_require__(9);

var _urijs2 = _interopRequireDefault(_urijs);

var _availability = __webpack_require__(12);
...
* @version 0.1.0
*/
var UserAvailabilityReporter = function (_EventEmitter) {
  _inherits(UserAvailabilityReporter, _EventEmitter);

  function UserAvailabilityReporter(hypertyURL, bus, configuration) {
    ...
    var _this2 = _possibleConstructorReturn(this, (UserAvailabilityReporter.__proto__ || Object.getPrototypeOf(UserAvailabilityReporter)).call(this, hypertyURL, bus, configuration));
    ...
    _this2.userAvailabilityyDescURL = 'hyperty-catalogue://catalogue.' + _this2.domain + '/.well-known/dataschema/Context';
  ...
  _createClass(UserAvailabilityReporter, [{
    ...
    value: function _create() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.syncher.create(_this.userAvailabilityyDescURL, [], (0, _availability2.default)(), true, false, 'myAvailability', null, { resources: ['availability_context'], expires: 3000 }).then(function (userAvailability) {
    ...
    key: '_onSubscription',
    value: function _onSubscription(userAvailability) {
      userAvailability.onSubscription(function (event) {
