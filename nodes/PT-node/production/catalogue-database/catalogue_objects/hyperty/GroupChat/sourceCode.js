...
var _Syncher = __webpack_require__(9);

var _GroupChat = __webpack_require__(10);

var _GroupChat2 = _interopRequireDefault(_GroupChat);

var _communication = __webpack_require__(12);
...
var GroupChatHyperty = {
    _getHyFor: function _getHyFor(participants) {
        ...
        return Promise.all(participants.map(function (p) {
            return _this.hypertyDiscoveryService.discoverHyperties(p.email, _this.scheme, _this.resources, p.domain).then(function (hyperties) {
                console.log(hyperties);
                var target = hyperties.sort(function (a, b) {
    ...
    _onAddChild: function _onAddChild(dataObject) {
        return function (callback) {
            console.log('onaddchildddd', dataObject);dataObject.onAddChild(function (child) {
    ...
    create: function create(name, participants) {
        ...
        return this._getHyFor(participants).then(function (hyperties) {
            var hys = {};
            hyperties.forEach(function (h) {
                return hys[h] = {};
            });
            hys[_this2.hypertyURL] = {};

            return _this2.syncher.create(_this2.objectDescURL, hyperties, (0, _communication2.default)(name, _this2.hypertyURL, hys), true, false, name, {}, { resources: ['chat'] });
            ...
            return _this2.identityManagerService.discoverUserRegistered().then(function (identity) {
                return (0, _GroupChat2.default)(dataObjectReporter.url, _this2._addChild(dataObjectReporter), _this2._onAddChild(dataObjectReporter), dataObjectReporter._name, dataObjectReporter.data, identity);
            });
        }).catch(function (err) {
            return console.error('[GROUPCHAT]', err);
        });
    },
    onInvite: function onInvite(callback) {
        ...
        this.syncher.onNotification(function (event) {
            ...
            if (event.schema.endsWith(_this3.groupChatDS) && event.value.resources[0] === 'chat') {
                _this3.syncher.subscribe(_this3.objectDescURL, event.url).then(function (dataObject) {
                    ...
                    return _this3.identityManagerService.discoverUserRegistered().then(function (identity) {
                        ...
                        callback((0, _GroupChat2.default)(dataObject.url, _this3._addChild(dataObject), _this3._onAddChild(dataObject), dataObject._name, dataObject.data, identity));
                    });
                });
            }
        });
...
var groupChatFactory = function groupChatFactory(hypertyURL, bus, config) {
    ...
    var hypertyDiscovery = new _Discovery2.default(hypertyURL, config.runtimeURL, bus);
...
exports.default = function (id, addChild, onAddChild, name, _ref, identity) {
...
var _GroupChatMessage = __webpack_require__(11);
...
var GroupChat = {
    sendMessage: function sendMessage(message, distance) {
        ...
        return this.addChild(message).then(function (child) {
