...
var RoomClient = function (_EventEmitter) {
    _inherits(RoomClient, _EventEmitter);
     ...
     */
    function RoomClient(hypertyURL, bus, configuration) {
        ...
        var _this = _possibleConstructorReturn(this, (RoomClient.__proto__ || Object.getPrototypeOf(RoomClient)).call(this));
        ...
        _this.contextSchemaURL = 'hyperty-catalogue://catalogue.' + (0, _utils.divideURL)(hypertyURL).domain + '/.well-known/dataschema/Context';
        ...
        // Syncher
        _this.syncher = new _Syncher.Syncher(hypertyURL, bus, configuration);

        if (autostart) {
            setTimeout(function () {
                l.d("forcing START with usertoken");
                _this.start("usertoken");
            }, 1000);
        }
        return _this;
    }
    ...
    _createClass(RoomClient, [{
        ...
        value: function start(token) {
            ...
            this.getRoomServerHypertyURL(roomServerIdentity).then(function (hypertyURL) {
                _this2.roomServerURL = hypertyURL;
                return _this2.requestRoomURLs(_this2.token, hypertyURL);
            }).then(function (urls) {
                return _this2.subscribeToRooms(urls);
            }).then(function (syncRooms) {
                l.d("Initialization done, room SyncObjects:", syncRooms);
            }).catch(function (error) {
                l.e(error);
                _this2.trigger("error", error);
            });
        }
        ...
        key: "discoverIdentity",
        value: function discoverIdentity() {
            var _this3 = this;

            l.d("discoverIdentity");
            return new Promise(function (resolve, reject) {
                // first discoverUserRegistered call
                _this3.identityManager.discoverUserRegistered().then(function (user) {
                    ...
                    if (user instanceof Object) {
                        ...
                        var errorString = "discovering user identity should have returned with an object, but instead returned with: " + user;
                        l.w(errorString);
                    ...
                    setTimeout(function () {
                        return _this3.discoverIdentity().then(resolve);
                    }, 500);
                });
            });
        }
        ...
        key: "getRoomServerHypertyURL",
        value: function getRoomServerHypertyURL(roomServerURL) {
            l.d("getRoomServerHypertyURL:", [roomServerURL]);
            return this.discovery.discoverHyperties(roomServerURL).then(function (hyperties) {
                l.d("found hyperties: ", hyperties);
                var latestRoomServerHyperty = void 0;
                ...
                for (hyperty in hyperties) {
                    ...
                    var name = hyperty.descriptor.substring(hyperty.descriptor.lastIndexOf('/') + 1);
                    l.d("checking name:", name);
                    if (name === "RoomServer" || name === "RoomServerNode") {
                        var date = hyperty.startingTime;
        ...
        key: "subscribeToRooms",
        value: function subscribeToRooms(urls) {
            var _this4 = this;

            l.d("subscribeToRooms:", [urls]);
            var subscribePromises = [];
            urls.forEach(function (url) {
                var p = _this4.subscribe(url);
        ...
        key: "requestRoomURLs",
        value: function requestRoomURLs(token, remoteHypertyURL) {
        ...
        key: "executeOnRemote",
        value: function executeOnRemote(remoteHypertyURL, method, params) {
            var _this5 = this;
            ...
            return new Promise(function (resolve, reject) {
                ...
                var msg = {
                    type: 'execute', from: _this5.hypertyURL, to: remoteHypertyURL,
                ...
                l.d("PRINTING THIS AGAIN:", _this5);
                _this5.bus.postMessage(msg, function (reply) {
                    l.d("got " + method + " reply!", reply);
                    if (reply.body.code == 200) {
                        var urls = reply.body.value;
                        resolve(urls);
                    } else {
        ...
        key: "subscribe",
        value: function subscribe(roomURL) {
            var _this6 = this;

            l.d("subscribe:", [roomURL]);
            return this.syncher.subscribe(this.contextSchemaURL, roomURL).then(function (room) {
                ...
                room.onChange('*', function (event) {
                    ...
                    _this6.trigger('changedRoom', room.data);
                });

                // trigger the newRoom event
                _this6.trigger('newRoom', room.data);
        ...
        key: "sendAction",
        value: function sendAction(deviceName, objectType, objectId, resourceType, value) {
