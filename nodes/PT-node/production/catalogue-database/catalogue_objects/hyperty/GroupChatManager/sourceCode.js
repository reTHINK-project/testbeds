...
var UserInfo = exports.UserInfo = function UserInfo(hypertyURL, domain, identity) {
  ...
  return _ref = {
    ...
    domain: domain }, _defineProperty(_ref, 'domain', domain), _defineProperty(_ref, 'identity', completeIdentity), _ref;
};
...
var _ChatController = __webpack_require__(8);

var _ChatController2 = _interopRequireDefault(_ChatController);

var _UserInfo = __webpack_require__(1);
      ...
      if (reportersList.length > 0) {
        ...
        Object.keys(reporters).forEach(function (dataObjectReporterURL) {
          ...
          _this.search.myIdentity().then(function (identity) {
            var chatController = new _ChatController2.default(syncher, _this.discovery, _this._domain, _this.search, identity, _this);
    ...
    value: function create(name, users, domains) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.search.myIdentity().then(function (identity) {
          ...
          var userInfo = new _UserInfo.UserInfo(_this._hypertyURL, _this._domain, identity);
