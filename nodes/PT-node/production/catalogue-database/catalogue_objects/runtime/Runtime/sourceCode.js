// version: 0.10.2
// date: Mon Dec 04 2017 10:43:57 GMT+0000 (WET)
// licence: 
/**
...
/***/
function(e,t,r){"use strict";if(r(8)){var n=r(49),i=r(4),o=r(5),a=r(0),s=r(88),u=r(125),c=r(27),f=r(55),l=r(47),d=r(18),p=r(57),y=r(33),h=r(10),v=r(171),g=r(51),b=r(31),m=r(17),_=r(72),R=r(6),w=r(14),S=r(116),O=r(52),M=r(25),P=r(53).f,E=r(118),k=r(48),x=r(7),L=r(35),U=r(79),T=r(86),D=r(121),A=r(63),I=r(83),j=r(54),N=r(120),C=r(161),F=r(9),q=r(24),H=F.f,V=q.f,B=i.RangeError,G=i.TypeError,K=i.Uint8Array,z=Array.prototype,W=u.ArrayBuffer,X=u.DataView,J=L(0),Y=L(2),Z=L(3),Q=L(4),$=L(5),ee=L(6),te=U(!0),re=U(!1),ne=D.values,ie=D.keys,oe=D.entries,ae=z.lastIndexOf,se=z.reduce,ue=z.reduceRight,ce=z.join,fe=z.sort,le=z.slice,de=z.toString,pe=z.toLocaleString,ye=x("iterator"),he=x("toStringTag"),ve=k("typed_constructor"),ge=k("def_constructor"),be=s.CONSTR,me=s.TYPED,_e=s.VIEW,Re=L(1,function(e,t){return Pe(T(e,e[ge]),t)}),we=o(function(){
// eslint-disable-next-line no-undef
return 1===new K(new Uint16Array([1]).buffer)[0]}),Se=!!K&&!!K.prototype.set&&o(function(){new K(1).set({})}),Oe=function(e,t){var r=y(e);if(r<0||r%t)throw B("Wrong offset!");return r},Me=function(e){if(R(e)&&me in e)return e;throw G(e+" is not a typed array!")},Pe=function(e,t){if(!(R(e)&&ve in e))throw G("It is not a typed array constructor!");return new e(t)},Ee=function(e,t){return ke(T(e,e[ge]),t)},ke=function(e,t){for(var r=0,n=t.length,i=Pe(e,n);n>r;)i[r]=t[r++];return i},xe=function(e,t,r){H(e,t,{get:function(){return this._d[r]}})},Le=function(e){var t,r,n,i,o,a,s=w(e),u=arguments.length,f=u>1?arguments[1]:void 0,l=void 0!==f,d=E(s);if(void 0!=d&&!S(d)){for(a=d.call(s),n=[],t=0;!(o=a.next()).done;t++)n.push(o.value);s=n}for(l&&u>2&&(f=c(f,arguments[2],2)),t=0,r=h(s.length),i=Pe(this,r);r>t;t++)i[t]=l?f(s[t],t):s[t];return i},Ue=function(){for(var e=0,t=arguments.length,r=Pe(this,t);t>e;)r[e]=arguments[e++];return r},Te=!!K&&o(function(){pe.call(new K(1))}),De=function(){return pe.apply(Te?le.call(Me(this)):Me(this),arguments)},Ae={copyWithin:function(e,t){return C.call(Me(this),e,t,arguments.length>2?arguments[2]:void 0)},every:function(e){return Q(Me(this),e,arguments.length>1?arguments[1]:void 0)},fill:function(e){// eslint-disable-line no-unused-vars
return N.apply(Me(this),arguments)},filter:function(e){return Ee(this,Y(Me(this),e,arguments.length>1?arguments[1]:void 0))},find:function(e){return $(Me(this),e,arguments.length>1?arguments[1]:void 0)},findIndex:function(e){return ee(Me(this),e,arguments.length>1?arguments[1]:void 0)},forEach:function(e){J(Me(this),e,arguments.length>1?arguments[1]:void 0)},indexOf:function(e){return re(Me(this),e,arguments.length>1?arguments[1]:void 0)},includes:function(e){return te(Me(this),e,arguments.length>1?arguments[1]:void 0)},join:function(e){// eslint-disable-line no-unused-vars
return ce.apply(Me(this),arguments)},lastIndexOf:function(e){// eslint-disable-line no-unused-vars
return ae.apply(Me(this),arguments)},map:function(e){return Re(Me(this),e,arguments.length>1?arguments[1]:void 0)},reduce:function(e){// eslint-disable-line no-unused-vars
return se.apply(Me(this),arguments)},reduceRight:function(e){// eslint-disable-line no-unused-vars
return ue.apply(Me(this),arguments)},reverse:function(){for(var e,t=this,r=Me(t).length,n=Math.floor(r/2),i=0;i<n;)e=t[i],t[i++]=t[--r],t[r]=e;return t},some:function(e){return Z(Me(this),e,arguments.length>1?arguments[1]:void 0)},sort:function(e){return fe.call(Me(this),e)},subarray:function(e,t){var r=Me(this),n=r.length,i=g(e,n);return new(T(r,r[ge]))(r.buffer,r.byteOffset+i*r.BYTES_PER_ELEMENT,h((void 0===t?n:g(t,n))-i))}},Ie=function(e,t){return Ee(this,le.call(Me(this),e,t))},je=function(e){Me(this);var t=Oe(arguments[1],1),r=this.length,n=w(e),i=h(n.length),o=0;if(i+t>r)throw B("Wrong length!");for(;o<i;)this[t+o]=n[o++]},Ne={entries:function(){return oe.call(Me(this))},keys:function(){return ie.call(Me(this))},values:function(){return ne.call(Me(this))}},Ce=function(e,t){return R(e)&&e[me]&&"symbol"!=typeof t&&t in e&&String(+t)==String(t)},Fe=function(e,t){return Ce(e,t=b(t,!0))?l(2,e[t]):V(e,t)},qe=function(e,t,r){return!(Ce(e,t=b(t,!0))&&R(r)&&m(r,"value"))||m(r,"get")||m(r,"set")||r.configurable||m(r,"writable")&&!r.writable||m(r,"enumerable")&&!r.enumerable?H(e,t,r):(e[t]=r.value,e)};be||(q.f=Fe,F.f=qe),a(a.S+a.F*!be,"Object",{getOwnPropertyDescriptor:Fe,defineProperty:qe}),o(function(){de.call({})})&&(de=pe=function(){return ce.call(this)});var He=p({},Ae);p(He,Ne),d(He,ye,Ne.values),p(He,{slice:Ie,set:je,constructor:function(){},toString:de,toLocaleString:De}),xe(He,"buffer","b"),xe(He,"byteOffset","o"),xe(He,"byteLength","l"),xe(He,"length","e"),H(He,he,{get:function(){return this[me]}}),
// eslint-disable-next-line max-statements
e.exports=function(e,t,r,u){u=!!u;var c=e+(u?"Clamped":"")+"Array",l="get"+e,p="set"+e,y=i[c],g=y||{},b=y&&M(y),m=!y||!s.ABV,w={},S=y&&y.prototype,E=function(e,r){var n=e._d;return n.v[l](r*t+n.o,we)},k=function(e,r,n){var i=e._d;u&&(n=(n=Math.round(n))<0?0:n>255?255:255&n),i.v[p](r*t+i.o,n,we)},x=function(e,t){H(e,t,{get:function(){return E(this,t)},set:function(e){return k(this,t,e)},enumerable:!0})};m?(y=r(function(e,r,n,i){f(e,y,c,"_d");var o,a,s,u,l=0,p=0;if(R(r)){if(!(r instanceof W||"ArrayBuffer"==(u=_(r))||"SharedArrayBuffer"==u))return me in r?ke(y,r):Le.call(y,r);o=r,p=Oe(n,t);var g=r.byteLength;if(void 0===i){if(g%t)throw B("Wrong length!");if((a=g-p)<0)throw B("Wrong length!")}else if((a=h(i)*t)+p>g)throw B("Wrong length!");s=a/t}else s=v(r),a=s*t,o=new W(a);for(d(e,"_d",{b:o,o:p,l:a,e:s,v:new X(o)});l<s;)x(e,l++)}),S=y.prototype=O(He),d(S,"constructor",y)):o(function(){y(1)})&&o(function(){new y(-1)})&&I(function(e){new y,// eslint-disable-line no-new
...
// `ws` module bug, temporarily remove validation length for Uint8Array
// https://github.com/websockets/ws/pull/645
return R(r)?r instanceof W||"ArrayBuffer"==(o=_(r))||"SharedArrayBuffer"==o?void 0!==i?new g(r,Oe(n,t),i):void 0!==n?new g(r,Oe(n,t)):new g(r):me in r?ke(y,r):Le.call(y,r):new g(v(r))}),J(b!==Function.prototype?P(g).concat(P(b)):P(g),function(e){e in y||d(y,e,g[e])}),y.prototype=S,n||(S.constructor=y));var L=S[ye],U=!!L&&("values"==L.name||void 0==L.name),T=Ne.values;d(y,ve,!0),d(S,me,c),d(S,_e,!0),d(S,ge,y),(u?new y(1)[he]==c:he in S)||H(S,he,{get:function(){return c}}),w[c]=y,a(a.G+a.W+a.F*(y!=g),w),a(a.S,c,{BYTES_PER_ELEMENT:t}),a(a.S+a.F*o(function(){g.of.call(y,1)}),c,{from:Le,of:Ue}),"BYTES_PER_ELEMENT"in S||d(S,"BYTES_PER_ELEMENT",t),a(a.P,c,Ae),j(c),a(a.P+a.F*Se,c,{set:je}),a(a.P+a.F*!U,c,Ne),n||S.toString==de||(S.toString=de),a(a.P+a.F*o(function(){new y(1).slice()}),c,{slice:Ie}),a(a.P+a.F*(o(function(){return[1,2].toLocaleString()!=new y([1,2]).toLocaleString()})||!o(function(){S.toLocaleString.call([1,2])})),c,{toLocaleString:De}),A[c]=U?L:T,n||U||d(S,ye,T)}}else e.exports=function(){}},/* 37 */
/***/
...
/***/
function(e,t,r){var n=r(39),i=r(181),o=r(130),a=Object.defineProperty;t.f=r(45)?Object.defineProperty:function(e,t,r){if(n(e),t=o(t,!0),n(r),i)try{return a(e,t,r)}catch(e){}if("get"in r||"set"in r)throw TypeError("Accessors not supported!");return"value"in r&&(e[t]=r.value),e}},/* 39 */
/***/
function(e,t,r){var n=r(44);e.exports=function(e){if(!n(e))throw TypeError(e+" is not an object!");return e}},/* 40 */
/***/
function(e,t,r){e.exports={default:r(436),__esModule:!0}},/* 41 */
/***/
function(e,t,r){e.exports={default:r(460),__esModule:!0}},/* 42 */
/***/
...
var n=r(7)("unscopables"),i=Array.prototype;void 0==i[n]&&r(18)(i,n,{}),e.exports=function(e){i[n][e]=!0}},/* 44 */
/***/
function(e,t){e.exports=function(e){return"object"==typeof e?null!==e:"function"==typeof e}},/* 45 */
/***/
function(e,t,r){
// Thank's IE8 for his funny defineProperty
...
function(e,t,r){
// to indexed object, toObject with fallback for non-array-like ES3 strings
var n=r(184),i=r(128);e.exports=function(e){return n(i(e))}},/* 47 */
/***/
...
/***/
function(e,t,r){var n=r(38),i=r(73);e.exports=r(45)?function(e,t,r){return n.f(e,t,i(1,r))}:function(e,t,r){return e[t]=r,e}},/* 59 */
/***/
...
/***/
function(e,t,r){"use strict";var n=r(4),i=r(0),o=r(19),a=r(57),s=r(42),u=r(56),c=r(55),f=r(6),l=r(5),d=r(83),p=r(61),y=r(107);e.exports=function(e,t,r,h,v,g){var b=n[e],m=b,_=v?"set":"add",R=m&&m.prototype,w={},S=function(e){var t=R[e];o(R,e,"delete"==e?function(e){return!(g&&!f(e))&&t.call(this,0===e?0:e)}:"has"==e?function(e){return!(g&&!f(e))&&t.call(this,0===e?0:e)}:"get"==e?function(e){return g&&!f(e)?void 0:t.call(this,0===e?0:e)}:"add"==e?function(e){return t.call(this,0===e?0:e),this}:function(e,r){return t.call(this,0===e?0:e,r),this})};if("function"==typeof m&&(g||R.forEach&&!l(function(){(new m).entries().next()}))){var O=new m,M=O[_](g?{}:-0,1)!=O,P=l(function(){O.has(1)}),E=d(function(e){new m(e)}),k=!g&&l(function(){for(
// V8 ~ Chromium 42- fails only with 5+ elements
var e=new m,t=5;t--;)e[_](t,t);return!e.has(-0)});E||(m=t(function(t,r){c(t,m,e);var n=y(new b,t,m);return void 0!=r&&u(r,v,n[_],n),n}),m.prototype=R,R.constructor=m),(P||k)&&(S("delete"),S("has"),v&&S("get")),(k||M)&&S(_),
...
/***/
function(e,t,r){"use strict";var n=r(49),i=r(0),o=r(19),a=r(18),s=r(17),u=r(63),c=r(113),f=r(61),l=r(25),d=r(7)("iterator"),p=!([].keys&&"next"in[].keys()),y=function(){return this};e.exports=function(e,t,r,h,v,g,b){c(r,t,h);var m,_,R,w=function(e){if(!p&&e in P)return P[e];switch(e){case"keys":case"values":return function(){return new r(this,e)}}return function(){return new r(this,e)}},S=t+" Iterator",O="values"==v,M=!1,P=e.prototype,E=P[d]||P["@@iterator"]||v&&P[v],k=E||w(v),x=v?O?w("entries"):k:void 0,L="Array"==t?P.entries||E:E;if(
// Fix native
L&&(R=l(L.call(new e)))!==Object.prototype&&R.next&&(
// Set @@toStringTag to native iterators
f(R,S,!0),
// fix for some old engines
n||s(R,d)||a(R,d,y)),
// fix Array#{values, @@iterator}.name in V8 / FF
O&&E&&"values"!==E.name&&(M=!0,k=function(){return E.call(this)}),
// Define iterator
n&&!b||!p&&!M&&P[d]||a(P,d,k),
// Plug for library
u[t]=k,u[S]=y,v)if(m={values:O?k:w("values"),keys:g?k:w("keys"),entries:x},b)for(_ in m)_ in P||o(P,_,m[_]);else i(i.P+i.F*(p||M),t,m);return m}},/* 113 */
/***/
...
/***/
function(e,t,r){"use strict";var n=r(43),i=r(162),o=r(63),a=r(23);
...
function packIEEE754(e,t,r){var n,i,o,a=Array(r),s=8*r-t-1,u=(1<<s)-1,c=u>>1,f=23===t?E(2,-24)-E(2,-77):0,l=0,d=e<0||0===e&&1/e<0?1:0;for(e=P(e),
// eslint-disable-next-line no-self-compare
e!=e||e===O?(
// eslint-disable-next-line no-self-compare
i=e!=e?1:0,n=u):(n=k(x(e)/L),e*(o=E(2,-n))<1&&(n--,o*=2),e+=n+c>=1?f/o:f*E(2,1-c),e*o>=2&&(n++,o/=2),n+c>=u?(i=0,n=u):n+c>=1?(i=(e*o-1)*E(2,t),n+=c):(i=e*E(2,c-1)*E(2,t),n=0));t>=8;a[l++]=255&i,i/=256,t-=8);for(n=n<<t|i,s+=t;s>0;a[l++]=255&n,n/=256,s-=8);return a[--l]|=128*d,a}function unpackIEEE754(e,t,r){var n,i=8*r-t-1,o=(1<<i)-1,a=o>>1,s=i-7,u=r-1,c=e[u--],f=127&c;for(c>>=7;s>0;f=256*f+e[u],u--,s-=8);for(n=f&(1<<-s)-1,f>>=-s,s+=t;s>0;n=256*n+e[u],u--,s-=8);if(0===f)f=1-a;else{if(f===o)return n?NaN:c?-O:O;n+=E(2,t),f-=a}return(c?-1:1)*n*E(2,f-t)}function unpackI32(e){return e[3]<<24|e[2]<<16|e[1]<<8|e[0]}function packI8(e){return[255&e]}function packI16(e){return[255&e,e>>8&255]}function packI32(e){return[255&e,e>>8&255,e>>16&255,e>>24&255]}function packF64(e){return packIEEE754(e,52,8)}function packF32(e){return packIEEE754(e,23,4)}function addGetter(e,t,r){h(e[b],t,{get:function(){return this[r]}})}function get(e,t,r,n){var i=+r,o=p(i);if(o+t>e[T])throw S(m);var a=e[U]._b,s=o+e[D],u=a.slice(s,s+t);return n?u:u.reverse()}function set(e,t,r,n,i,o){var a=+r,s=p(a);if(s+t>e[T])throw S(m);for(var u=e[U]._b,c=s+e[D],f=n(+i),l=0;l<t;l++)u[c+l]=f[o?l:t-l-1]}var n=r(4),i=r(8),o=r(49),a=r(88),s=r(18),u=r(57),c=r(5),f=r(55),l=r(33),d=r(10),p=r(171),y=r(53).f,h=r(9).f,v=r(120),g=r(61),b="prototype",m="Wrong index!",_=n.ArrayBuffer,R=n.DataView,w=n.Math,S=n.RangeError,O=n.Infinity,M=_,P=w.abs,E=w.pow,k=w.floor,x=w.log,L=w.LN2,U=i?"_b":"buffer",T=i?"_l":"byteLength",D=i?"_o":"byteOffset";if(a.ABV){if(!c(function(){_(1)})||!c(function(){new _(-1)})||c(function(){// eslint-disable-line no-new
// eslint-disable-line no-new
// eslint-disable-line no-new
return new _,new _(1.5),new _(NaN),"ArrayBuffer"!=_.name})){_=function(e){return f(this,_),new M(p(e))};for(var A,I=_[b]=M[b],j=y(M),N=0;j.length>N;)(A=j[N++])in _||s(_,A,M[A]);o||(I.constructor=_)}
// iOS Safari 7.x bug
var C=new R(new _(2)),F=R[b].setInt8;C.setInt8(0,2147483648),C.setInt8(1,2147483649),!C.getInt8(0)&&C.getInt8(1)||u(R[b],{setInt8:function(e,t){F.call(this,e,t<<24>>24)},setUint8:function(e,t){F.call(this,e,t<<24>>24)}},!0)}else _=function(e){f(this,_,"ArrayBuffer");var t=p(e);this._b=v.call(Array(t),0),this[T]=t},R=function(e,t,r){f(this,R,"DataView"),f(e,_,"DataView");var n=e[T],i=l(t);if(i<0||i>n)throw S("Wrong offset!");if(r=void 0===r?n-i:d(r),i+r>n)throw S("Wrong length!");this[U]=e,this[D]=i,this[T]=r},i&&(addGetter(_,"byteLength","_l"),addGetter(R,"buffer","_b"),addGetter(R,"byteLength","_l"),addGetter(R,"byteOffset","_o")),u(R[b],{getInt8:function(e){return get(this,1,e)[0]<<24>>24},getUint8:function(e){return get(this,1,e)[0]},getInt16:function(e){var t=get(this,2,e,arguments[1]);return(t[1]<<8|t[0])<<16>>16},getUint16:function(e){var t=get(this,2,e,arguments[1]);return t[1]<<8|t[0]},getInt32:function(e){return unpackI32(get(this,4,e,arguments[1]))},getUint32:function(e){return unpackI32(get(this,4,e,arguments[1]))>>>0},getFloat32:function(e){return unpackIEEE754(get(this,4,e,arguments[1]),23,4)},getFloat64:function(e){return unpackIEEE754(get(this,8,e,arguments[1]),52,8)},setInt8:function(e,t){set(this,1,e,packI8,t)},setUint8:function(e,t){set(this,1,e,packI8,t)},setInt16:function(e,t){set(this,2,e,packI16,t,arguments[2])},setUint16:function(e,t){set(this,2,e,packI16,t,arguments[2])},setInt32:function(e,t){set(this,4,e,packI32,t,arguments[2])},setUint32:function(e,t){set(this,4,e,packI32,t,arguments[2])},setFloat32:function(e,t){set(this,4,e,packF32,t,arguments[2])},setFloat64:function(e,t){set(this,8,e,packF64,t,arguments[2])}});g(_,"ArrayBuffer"),g(R,"DataView"),s(R[b],a.VIEW,!0),t.ArrayBuffer=_,t.DataView=R},/* 126 */
/***/
...
/***/
function(e,t,r){var n=r(44),i=r(21).document,o=n(i)&&n(i.createElement);e.exports=function(e){return o?i.createElement(e):{}}},/* 130 */
/***/
function(e,t,r){
// 7.1.1 ToPrimitive(input [, PreferredType])
var n=r(44);
...
/***/
function(e,t,r){var n=r(77),i=r(73),o=r(46),a=r(130),s=r(59),u=r(181),c=Object.getOwnPropertyDescriptor;t.f=r(45)?c:function(e,t){if(e=o(e),t=a(t,!0),u)try{return c(e,t)}catch(e){}if(s(e,t))return i(!n.f.call(e,t),e[t])}},/* 142 */
/***/
...
/***/
function(e,t,r){"use strict";var n=r(9).f,i=r(52),o=r(57),a=r(27),s=r(55),u=r(56),c=r(112),f=r(162),l=r(54),d=r(8),p=r(42).fastKey,y=r(64),h=d?"_s":"size",v=function(e,t){
// fast case
...
/***/
function(e,t,r){"use strict";var n,i=r(35)(0),o=r(19),a=r(42),s=r(150),u=r(170),c=r(6),f=r(5),l=r(64),d=a.getWeak,p=Object.isExtensible,y=u.ufstore,h={},v=function(e){return function(){return e(this,arguments.length>0?arguments[0]:void 0)}},g={
...
n&&!b||!p&&!M&&P[d]||a(P,d,k),
// Plug for library
u[t]=k,u[S]=y,v)if(m={values:O?k:w("values"),keys:g?k:w("keys"),entries:x},b)for(_ in m)_ in P||o(P,_,m[_]);else i(i.P+i.F*(p||M),t,m);return m}},/* 181 */
/***/
function(e,t,r){e.exports=!r(45)&&!r(66)(function(){return 7!=Object.defineProperty(r(129)("div"),"a",{get:function(){return 7}}).a})},/* 182 */
/***/
function(e,t,r){e.exports=r(58)},/* 183 */
/***/
function(e,t,r){var n=r(59),i=r(46),o=r(415)(!1),a=r(133)("IE_PROTO");e.exports=function(e,t){var r,s=i(e),u=0,c=[];for(r in s)r!=a&&n(s,r)&&c.push(r);
// Don't enum bug & hidden keys
...
/***/
function(e,t,r){var n=r(39),i=r(44),o=r(136);e.exports=function(e,t){if(n(e),i(t)&&t.constructor===e)return t;var r=o.f(e);return(0,r.resolve)(t),r.promise}},/* 196 */
/***/
...
/***/
function(e,t,r){e.exports={default:r(496),__esModule:!0}},/* 206 */
/***/
...
var n=r(4),i=r(17),o=r(8),a=r(0),s=r(19),u=r(42).KEY,c=r(5),f=r(78),l=r(61),d=r(48),p=r(7),y=r(146),h=r(101),v=r(211),g=r(81),b=r(3),m=r(23),_=r(31),R=r(47),w=r(52),S=r(149),O=r(24),M=r(9),P=r(50),E=O.f,k=M.f,x=S.f,L=n.Symbol,U=n.JSON,T=U&&U.stringify,D=p("_hidden"),A=p("toPrimitive"),I={}.propertyIsEnumerable,j=f("symbol-registry"),N=f("symbols"),C=f("op-symbols"),F=Object.prototype,q="function"==typeof L,H=n.QObject,V=!H||!H.prototype||!H.prototype.findChild,B=o&&c(function(){return 7!=w(k({},"a",{get:function(){return k(this,"a",{value:7}).a}})).a})?function(e,t,r){var n=E(F,t);n&&delete F[t],k(e,t,r),n&&e!==F&&k(F,t,n)}:k,G=function(e){var t=N[e]=w(L.prototype);return t._k=e,t},K=q&&"symbol"==typeof L.iterator?function(e){return"symbol"==typeof e}:function(e){return e instanceof L},z=function(e,t,r){return e===F&&z(C,t,r),b(e),t=_(t,!0),b(r),i(N,t)?(r.enumerable?(i(e,D)&&e[D][t]&&(e[D][t]=!1),r=w(r,{enumerable:R(0,!1)})):(i(e,D)||k(e,D,R(1,{})),e[D][t]=!0),B(e,t,r)):k(e,t,r)},W=function(e,t){b(e);for(var r,n=v(t=m(t)),i=0,o=n.length;o>i;)z(e,r=n[i++],t[r]);return e},X=function(e,t){return void 0===t?w(e):W(w(e),t)},J=function(e){var t=I.call(this,e=_(e,!0));return!(this===F&&i(N,e)&&!i(C,e))&&(!(t||!i(this,e)||!i(N,e)||i(this,D)&&this[D][e])||t)},Y=function(e,t){if(e=m(e),t=_(t,!0),e!==F||!i(N,t)||i(C,t)){var r=E(e,t);return!r||!i(N,t)||i(e,D)&&e[D][t]||(r.enumerable=!0),r}},Z=function(e){for(var t,r=x(m(e)),n=[],o=0;r.length>o;)i(N,t=r[o++])||t==D||t==u||n.push(t);return n},Q=function(e){for(var t,r=e===F,n=x(r?C:m(e)),o=[],a=0;n.length>a;)!i(N,t=n[a++])||r&&!i(F,t)||o.push(N[t]);return o};
// 19.4.1.1 Symbol([description])
q||(L=function(){if(this instanceof L)throw TypeError("Symbol is not a constructor!");var e=d(arguments.length>0?arguments[0]:void 0),t=function(r){this===F&&t.call(C,r),i(this,D)&&i(this[D],e)&&(this[D][e]=!1),B(this,e,R(1,r))};return o&&V&&B(F,e,{configurable:!0,set:t}),G(e)},s(L.prototype,"toString",function(){return this._k}),O.f=Y,M.f=z,r(53).f=S.f=Z,r(71).f=J,r(80).f=Q,o&&!r(49)&&s(F,"propertyIsEnumerable",J,!0),y.f=function(e){return G(p(e))}),a(a.G+a.W+a.F*!q,{Symbol:L});for(var $="hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","),ee=0;$.length>ee;)p($[ee++]);for(var te=P(p.store),re=0;te.length>re;)h(te[re++]);a(a.S+a.F*!q,"Symbol",{
// 19.4.2.1 Symbol.for(key)
for:function(e){return i(j,e+="")?j[e]:j[e]=L(e)},
// 19.4.2.5 Symbol.keyFor(sym)
keyFor:function(e){if(!K(e))throw TypeError(e+" is not a symbol!");for(var t in j)if(j[t]===e)return t},useSetter:function(){V=!0},useSimple:function(){V=!1}}),a(a.S+a.F*!q,"Object",{
...
U&&a(a.S+a.F*(!q||c(function(){var e=L();
// MS Edge converts symbol values to JSON as {}
// WebKit converts symbol values to JSON as null
// V8 throws on boxed symbols
return"[null]"!=T([e])||"{}"!=T({a:e})||"{}"!=T(Object(e))})),"JSON",{stringify:function(e){if(void 0!==e&&!K(e)){for(// IE8 returns string on undefined
var t,r,n=[e],i=1;arguments.length>i;)n.push(arguments[i++]);return t=n[1],"function"==typeof t&&(r=t),!r&&g(t)||(t=function(e,t){if(r&&(t=r.call(this,e,t)),!K(t))return t}),n[1]=t,T.apply(U,n)}}}),
// 19.4.3.4 Symbol.prototype[@@toPrimitive](hint)
L.prototype[A]||r(18)(L.prototype,A,L.prototype.valueOf),
...
var n=r(6),i=r(42).onFreeze;r(34)("freeze",function(e){return function(t){return e&&n(t)?e(i(t)):t}})},/* 220 */
/***/
function(e,t,r){
// 19.1.2.17 Object.seal(O)
var n=r(6),i=r(42).onFreeze;r(34)("seal",function(e){return function(t){return e&&n(t)?e(i(t)):t}})},/* 221 */
/***/
function(e,t,r){
// 19.1.2.15 Object.preventExtensions(O)
var n=r(6),i=r(42).onFreeze;r(34)("preventExtensions",function(e){return function(t){return e&&n(t)?e(i(t)):t}})},/* 222 */
/***/
function(e,t,r){
...
function(e,t,r){
// 22.1.3.3 Array.prototype.copyWithin(target, start, end = this.length)
var n=r(0);n(n.P,"Array",{copyWithin:r(161)}),r(43)("copyWithin")},/* 310 */
/***/
function(e,t,r){
// 22.1.3.6 Array.prototype.fill(value, start = 0, end = this.length)
var n=r(0);n(n.P,"Array",{fill:r(120)}),r(43)("fill")},/* 311 */
/***/
function(e,t,r){"use strict";
// 22.1.3.8 Array.prototype.find(predicate, thisArg = undefined)
var n=r(0),i=r(35)(5),o=!0;
// Shouldn't skip holes
"find"in[]&&Array(1).find(function(){o=!1}),n(n.P+n.F*o,"Array",{find:function(e){return i(this,e,arguments.length>1?arguments[1]:void 0)}}),r(43)("find")},/* 312 */
/***/
function(e,t,r){"use strict";
// 22.1.3.9 Array.prototype.findIndex(predicate, thisArg = undefined)
var n=r(0),i=r(35)(6),o="findIndex",a=!0;
// Shouldn't skip holes
o in[]&&Array(1)[o](function(){a=!1}),n(n.P+n.F*a,"Array",{findIndex:function(e){return i(this,e,arguments.length>1?arguments[1]:void 0)}}),r(43)(o)},/* 313 */
/***/
...
/***/
function(e,t,r){"use strict";var n,i,o,a,s=r(49),u=r(4),c=r(27),f=r(72),l=r(0),d=r(6),p=r(16),y=r(55),h=r(56),v=r(86),g=r(122).set,b=r(123)(),m=r(124),_=r(164),R=r(165),w=u.TypeError,S=u.process,O=u.Promise,M="process"==f(S),P=function(){},E=i=m.f,k=!!function(){try{
// correct subclassing with @@species support
var e=O.resolve(1),t=(e.constructor={})[r(7)("species")]=function(e){e(P,P)};
// unhandled rejections tracking support, NodeJS Promise without it fails @@species test
return(M||"function"==typeof PromiseRejectionEvent)&&e.then(P)instanceof t}catch(e){}}(),x=function(e){var t;return!(!d(e)||"function"!=typeof(t=e.then))&&t},L=function(e,t){if(!e._n){e._n=!0;var r=e._c;b(function(){for(var n=e._v,i=1==e._s,o=0;r.length>o;)!function(t){var r,o,a=i?t.ok:t.fail,s=t.resolve,u=t.reject,c=t.domain;try{a?(i||(2==e._h&&D(e),e._h=1),!0===a?r=n:(c&&c.enter(),r=a(n),c&&c.exit()),r===t.promise?u(w("Promise-chain cycle")):(o=x(r))?o.call(r,s,u):s(r)):u(n)}catch(e){u(e)}}(r[o++]);// variable length - can't use forEach
e._c=[],e._n=!1,t&&!e._h&&U(e)})}},U=function(e){g.call(u,function(){var t,r,n,i=e._v,o=T(e);if(o&&(t=_(function(){M?S.emit("unhandledRejection",i,e):(r=u.onunhandledrejection)?r({promise:e,reason:i}):(n=u.console)&&n.error&&n.error("Unhandled promise rejection",i)}),
// Browsers should not trigger `rejectionHandled` event if it was handled here, NodeJS - should
e._h=M||T(e)?2:1),e._a=void 0,o&&t.e)throw t.v})},T=function(e){if(1==e._h)return!1;for(var t,r=e._a||e._c,n=0;r.length>n;)if(t=r[n++],t.fail||!T(t.promise))return!1;return!0},D=function(e){g.call(u,function(){var t;M?S.emit("rejectionHandled",e):(t=u.onrejectionhandled)&&t({promise:e,reason:e._v})})},A=function(e){var t=this;t._d||(t._d=!0,t=t._w||t,// unwrap
t._v=e,t._s=2,t._a||(t._a=t._c.slice()),L(t,!0))},I=function(e){var t,r=this;if(!r._d){r._d=!0,r=r._w||r;// unwrap
try{if(r===e)throw w("Promise can't be resolved itself");(t=x(e))?b(function(){var n={_w:r,_d:!1};// wrap
try{t.call(e,c(I,n,1),c(A,n,1))}catch(e){A.call(n,e)}}):(r._v=e,r._s=1,L(r,!1))}catch(e){A.call({_w:r,_d:!1},e)}}};
// constructor polyfill
k||(
// 25.4.3.1 Promise(executor)
O=function(e){y(this,O,"Promise","_h"),p(e),n.call(this);try{e(c(I,this,1),c(A,this,1))}catch(e){A.call(this,e)}},
// eslint-disable-next-line no-unused-vars
...
then:function(e,t){var r=E(v(this,O));return r.ok="function"!=typeof e||e,r.fail="function"==typeof t&&t,r.domain=M?S.domain:void 0,this._c.push(r),this._a&&this._a.push(r),this._s&&L(this,!1),r.promise},
// 25.4.5.1 Promise.prototype.catch(onRejected)
catch:function(e){return this.then(void 0,e)}}),o=function(){var e=new n;this.promise=e,this.resolve=c(I,e,1),this.reject=c(A,e,1)},m.f=E=function(e){return e===O||e===a?new o(e):i(e)}),l(l.G+l.W+l.F*!k,{Promise:O}),r(61)(O,"Promise"),r(54)("Promise"),a=r(30).Promise,
// statics
l(l.S+l.F*!k,"Promise",{
// 25.4.4.5 Promise.reject(r)
reject:function(e){var t=E(this);return(0,t.reject)(e),t.promise}}),l(l.S+l.F*(s||!k),"Promise",{
// 25.4.4.6 Promise.resolve(x)
resolve:function(e){return R(s&&this===a?O:this,e)}}),l(l.S+l.F*!(k&&r(83)(function(e){O.all(e).catch(P)})),"Promise",{
// 25.4.4.1 Promise.all(iterable)
all:function(e){var t=this,r=E(t),n=r.resolve,i=r.reject,o=_(function(){var r=[],o=0,a=1;h(e,!1,function(e){var s=o++,u=!1;r.push(void 0),a++,t.resolve(e).then(function(e){u||(u=!0,r[s]=e,--a||n(r))},i)}),--a||n(r)});return o.e&&i(o.v),r.promise},
// 25.4.4.4 Promise.race(iterable)
race:function(e){var t=this,r=E(t),n=r.reject,i=_(function(){h(e,!1,function(e){t.resolve(e).then(r.resolve,n)})});return i.e&&n(i.v),r.promise}})},/* 321 */
/***/
...
var n=r(0),i=r(79)(!0);n(n.P,"Array",{includes:function(e){return i(this,e,arguments.length>1?arguments[1]:void 0)}}),r(43)("includes")},/* 348 */
/***/
function(e,t,r){"use strict";
// https://tc39.github.io/proposal-flatMap/#sec-Array.prototype.flatMap
var n=r(0),i=r(173),o=r(14),a=r(10),s=r(16),u=r(119);n(n.P,"Array",{flatMap:function(e){var t,r,n=o(this);return s(e),t=a(n.length),r=u(n,0),i(r,n,n,t,0,1,e,arguments[1]),r}}),r(43)("flatMap")},/* 349 */
/***/
function(e,t,r){"use strict";
// https://tc39.github.io/proposal-flatMap/#sec-Array.prototype.flatten
var n=r(0),i=r(173),o=r(14),a=r(10),s=r(33),u=r(119);n(n.P,"Array",{flatten:function(){var e=arguments[0],t=o(this),r=a(t.length),n=u(t,0);return i(n,t,t,r,0,void 0===e?1:s(e)),n}}),r(43)("flatten")},/* 350 */
/***/
function(e,t,r){"use strict";
...
/***/
function(e,t,r){"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var n=r(12),i=_interopRequireDefault(n),o=r(96),a=_interopRequireDefault(o),s=r(1),u=_interopRequireDefault(s),c=r(2),f=_interopRequireDefault(c),l=r(434),d=r(11),p=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t}(d),y=r(435),h=_interopRequireDefault(y),v=r(465),g=_interopRequireDefault(v),b=r(470),m=_interopRequireDefault(b),_=r(481),R=_interopRequireDefault(_),w=r(15),S=r(99),O=_interopRequireDefault(S),M=r(483),P=_interopRequireDefault(M),E=r(484),k=_interopRequireDefault(E),x=r(485),L=r(138),U=r(486),T=_interopRequireDefault(U),D=r(488),A=_interopRequireDefault(D),I=r(489),j=_interopRequireDefault(I),N=r(494),C=_interopRequireDefault(N),F=r(495),q=_interopRequireDefault(F),H=r(506),V=_interopRequireDefault(H),B=r(508),G=_interopRequireDefault(B),K=p.getLogger("RuntimeUA"),z=function(){/**
...
e.policyEngine=new m.default(new G.default(e.runtimeURL,e.identityModule,e.registry,e.storageManager,e.runtimeCapabilities)),e.messageBus.pipeline.handlers=[
// Policy message authorise
function(t){e.policyEngine.authorise(t.msg).then(function(e){t.msg=e,t.next()}).catch(function(e){K.error(e),t.fail(e)})}],
// Instantiate the Graph Connector
e.graphConnector=new T.default(e.runtimeURL,e.messageBus,e.storageManager),
...
e.subscriptionManager=new V.default(e.runtimeURL,e.messageBus,e.storageManager);
...
/***/
function(e,t,r){var n=r(38),i=r(39),o=r(67);e.exports=r(45)?Object.defineProperties:function(e,t){i(e);for(var r,a=o(t),s=a.length,u=0;s>u;)n.f(e,r=a[u++],t[r]);return e}},/* 415 */
/***/
function(e,t,r){
// false -> Array#indexOf
// true  -> Array#includes
var n=r(46),i=r(132),o=r(416);e.exports=function(e){return function(t,r,a){var s,u=n(t),c=i(u.length),f=o(a,c);
// Array#includes uses SameValueZero equality algorithm
// eslint-disable-next-line no-self-compare
if(e&&r!=r){for(;c>f;)
// eslint-disable-next-line no-self-compare
...
/***/
function(e,t,r){"use strict";var n=r(418),i=r(419),o=r(74),a=r(46);
// 22.1.3.4 Array.prototype.entries()
// 22.1.3.13 Array.prototype.keys()
// 22.1.3.29 Array.prototype.values()
// 22.1.3.30 Array.prototype[@@iterator]()
...
/***/
function(e,t,r){"use strict";var n,i,o,a,s=r(92),u=r(21),c=r(65),f=r(188),l=r(26),d=r(44),p=r(93),y=r(421),h=r(422),v=r(192),g=r(193).set,b=r(424)(),m=r(136),_=r(194),R=r(195),w=u.TypeError,S=u.process,O=u.Promise,M="process"==f(S),P=function(){},E=i=m.f,k=!!function(){try{
// correct subclassing with @@species support
var e=O.resolve(1),t=(e.constructor={})[r(22)("species")]=function(e){e(P,P)};
// unhandled rejections tracking support, NodeJS Promise without it fails @@species test
return(M||"function"==typeof PromiseRejectionEvent)&&e.then(P)instanceof t}catch(e){}}(),x=function(e){var t;return!(!d(e)||"function"!=typeof(t=e.then))&&t},L=function(e,t){if(!e._n){e._n=!0;var r=e._c;b(function(){for(var n=e._v,i=1==e._s,o=0;r.length>o;)!function(t){var r,o,a=i?t.ok:t.fail,s=t.resolve,u=t.reject,c=t.domain;try{a?(i||(2==e._h&&D(e),e._h=1),!0===a?r=n:(c&&c.enter(),r=a(n),c&&c.exit()),r===t.promise?u(w("Promise-chain cycle")):(o=x(r))?o.call(r,s,u):s(r)):u(n)}catch(e){u(e)}}(r[o++]);// variable length - can't use forEach
e._c=[],e._n=!1,t&&!e._h&&U(e)})}},U=function(e){g.call(u,function(){var t,r,n,i=e._v,o=T(e);if(o&&(t=_(function(){M?S.emit("unhandledRejection",i,e):(r=u.onunhandledrejection)?r({promise:e,reason:i}):(n=u.console)&&n.error&&n.error("Unhandled promise rejection",i)}),
// Browsers should not trigger `rejectionHandled` event if it was handled here, NodeJS - should
...
then:function(e,t){var r=E(v(this,O));return r.ok="function"!=typeof e||e,r.fail="function"==typeof t&&t,r.domain=M?S.domain:void 0,this._c.push(r),this._a&&this._a.push(r),this._s&&L(this,!1),r.promise},
// 25.4.5.1 Promise.prototype.catch(onRejected)
catch:function(e){return this.then(void 0,e)}}),o=function(){var e=new n;this.promise=e,this.resolve=c(I,e,1),this.reject=c(A,e,1)},m.f=E=function(e){return e===O||e===a?new o(e):i(e)}),l(l.G+l.W+l.F*!k,{Promise:O}),r(95)(O,"Promise"),r(426)("Promise"),a=r(13).Promise,
// statics
l(l.S+l.F*!k,"Promise",{
// 25.4.4.5 Promise.reject(r)
reject:function(e){var t=E(this);return(0,t.reject)(e),t.promise}}),l(l.S+l.F*(s||!k),"Promise",{
// 25.4.4.6 Promise.resolve(x)
resolve:function(e){return R(s&&this===a?O:this,e)}}),l(l.S+l.F*!(k&&r(196)(function(e){O.all(e).catch(P)})),"Promise",{
// 25.4.4.1 Promise.all(iterable)
all:function(e){var t=this,r=E(t),n=r.resolve,i=r.reject,o=_(function(){var r=[],o=0,a=1;h(e,!1,function(e){var s=o++,u=!1;r.push(void 0),a++,t.resolve(e).then(function(e){u||(u=!0,r[s]=e,--a||n(r))},i)}),--a||n(r)});return o.e&&i(o.v),r.promise},
// 25.4.4.4 Promise.race(iterable)
race:function(e){var t=this,r=E(t),n=r.reject,i=_(function(){h(e,!1,function(e){t.resolve(e).then(r.resolve,n)})});return i.e&&n(i.v),r.promise}})},/* 421 */
/***/
...
/***/
function(e,t,r){"use strict";var n=r(21),i=r(13),o=r(38),a=r(45),s=r(22)("species");e.exports=function(e){var t="function"==typeof i[e]?i[e]:n[e];a&&t&&!t[s]&&o.f(t,s,{configurable:!0,get:function(){return this}})}},/* 427 */
/***/
function(e,t,r){"use strict";
// https://github.com/tc39/proposal-promise-finally
...
// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
n(n.S+n.F*!r(45),"Object",{defineProperty:r(38).f})},/* 434 */
/***/
...
var r=v.default.instance;t.addressAllocation=r}}]),Registry}();t.default=M,e.exports=t.default},/* 436 */
/***/
...
function(e,t,r){"use strict";
// ECMAScript 6 symbols shim
var n=r(21),i=r(59),o=r(45),a=r(26),s=r(182),u=r(446).KEY,c=r(66),f=r(134),l=r(95),d=r(94),p=r(22),y=r(139),h=r(140),v=r(447),g=r(448),b=r(39),m=r(46),_=r(130),R=r(73),w=r(131),S=r(449),O=r(141),M=r(38),P=r(67),E=O.f,k=M.f,x=S.f,L=n.Symbol,U=n.JSON,T=U&&U.stringify,D=p("_hidden"),A=p("toPrimitive"),I={}.propertyIsEnumerable,j=f("symbol-registry"),N=f("symbols"),C=f("op-symbols"),F=Object.prototype,q="function"==typeof L,H=n.QObject,V=!H||!H.prototype||!H.prototype.findChild,B=o&&c(function(){return 7!=w(k({},"a",{get:function(){return k(this,"a",{value:7}).a}})).a})?function(e,t,r){var n=E(F,t);n&&delete F[t],k(e,t,r),n&&e!==F&&k(F,t,n)}:k,G=function(e){var t=N[e]=w(L.prototype);return t._k=e,t},K=q&&"symbol"==typeof L.iterator?function(e){return"symbol"==typeof e}:function(e){return e instanceof L},z=function(e,t,r){return e===F&&z(C,t,r),b(e),t=_(t,!0),b(r),i(N,t)?(r.enumerable?(i(e,D)&&e[D][t]&&(e[D][t]=!1),r=w(r,{enumerable:R(0,!1)})):(i(e,D)||k(e,D,R(1,{})),e[D][t]=!0),B(e,t,r)):k(e,t,r)},W=function(e,t){b(e);for(var r,n=v(t=m(t)),i=0,o=n.length;o>i;)z(e,r=n[i++],t[r]);return e},X=function(e,t){return void 0===t?w(e):W(w(e),t)},J=function(e){var t=I.call(this,e=_(e,!0));return!(this===F&&i(N,e)&&!i(C,e))&&(!(t||!i(this,e)||!i(N,e)||i(this,D)&&this[D][e])||t)},Y=function(e,t){if(e=m(e),t=_(t,!0),e!==F||!i(N,t)||i(C,t)){var r=E(e,t);return!r||!i(N,t)||i(e,D)&&e[D][t]||(r.enumerable=!0),r}},Z=function(e){for(var t,r=x(m(e)),n=[],o=0;r.length>o;)i(N,t=r[o++])||t==D||t==u||n.push(t);return n},Q=function(e){for(var t,r=e===F,n=x(r?C:m(e)),o=[],a=0;n.length>a;)!i(N,t=n[a++])||r&&!i(F,t)||o.push(N[t]);return o};
// 19.4.1.1 Symbol([description])
q||(L=function(){if(this instanceof L)throw TypeError("Symbol is not a constructor!");var e=d(arguments.length>0?arguments[0]:void 0),t=function(r){this===F&&t.call(C,r),i(this,D)&&i(this[D],e)&&(this[D][e]=!1),B(this,e,R(1,r))};return o&&V&&B(F,e,{configurable:!0,set:t}),G(e)},s(L.prototype,"toString",function(){return this._k}),O.f=Y,M.f=z,r(198).f=S.f=Z,r(77).f=J,r(137).f=Q,o&&!r(92)&&s(F,"propertyIsEnumerable",J,!0),y.f=function(e){return G(p(e))}),a(a.G+a.W+a.F*!q,{Symbol:L});for(var $="hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","),ee=0;$.length>ee;)p($[ee++]);for(var te=P(p.store),re=0;te.length>re;)h(te[re++]);a(a.S+a.F*!q,"Symbol",{
// 19.4.2.1 Symbol.for(key)
for:function(e){return i(j,e+="")?j[e]:j[e]=L(e)},
// 19.4.2.5 Symbol.keyFor(sym)
keyFor:function(e){if(!K(e))throw TypeError(e+" is not a symbol!");for(var t in j)if(j[t]===e)return t},useSetter:function(){V=!0},useSimple:function(){V=!1}}),a(a.S+a.F*!q,"Object",{
...
var t,r,n=[e],i=1;arguments.length>i;)n.push(arguments[i++]);return t=n[1],"function"==typeof t&&(r=t),!r&&g(t)||(t=function(e,t){if(r&&(t=r.call(this,e,t)),!K(t))return t}),n[1]=t,T.apply(U,n)}}}),
// 19.4.3.4 Symbol.prototype[@@toPrimitive](hint)
L.prototype[A]||r(58)(L.prototype,A,L.prototype.valueOf),
// 19.4.3.5 Symbol.prototype[@@toStringTag]
l(L,"Symbol"),
// 20.2.1.9 Math[@@toStringTag]
l(Math,"Math",!0),
...
l(n.JSON,"JSON",!0)},/* 446 */
/***/
function(e,t,r){var n=r(94)("meta"),i=r(44),o=r(59),a=r(38).f,s=0,u=Object.isExtensible||function(){return!0},c=!r(66)(function(){return u(Object.preventExtensions({}))}),f=function(e){a(e,n,{value:{i:"O"+ ++s,// object ID
w:{}}})},l=function(e,t){
// return primitive with prefix
if(!i(e))return"symbol"==typeof e?e:("string"==typeof e?"S":"P")+e;if(!o(e,n)){
// can't set metadata to uncaught frozen object
...
function(e,t,r){
// fallback for IE11 buggy Object.getOwnPropertyNames with iframe and window
var n=r(46),i=r(198).f,o={}.toString,a="object"==typeof window&&window&&Object.getOwnPropertyNames?Object.getOwnPropertyNames(window):[],s=function(e){try{return i(e)}catch(e){return a.slice()}};e.exports.f=function(e){return a&&"[object Window]"==o.call(e)?s(e):i(n(e))}},/* 450 */
/***/
...
// Works with __proto__ only. Old v8 can't work with null proto objects.
/* eslint-disable no-proto */
var n=r(44),i=r(39),o=function(e,t){if(i(e),!n(t)&&null!==t)throw TypeError(t+": can't set as prototype!")};e.exports={set:Object.setPrototypeOf||("__proto__"in{}?// eslint-disable-line
...
/***/
function(e,t,r){"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _chatkeysToStringCloner(e,t){var r={},n=(0,i.default)(t);if(n)try{for(var o=0;o<n.length;o++){var a=n[o];r[a]={},r[a].sessionKey=t[a].sessionKey.toString(),r[a].isToEncrypt=t[a].isToEncrypt}}catch(e){M.error("_chatkeysToStringCloner:err",e)}return r}function _chatkeysToArrayCloner(e,t){var r={},n=(0,i.default)(t);if(n)try{for(var o=0;o<n.length;o++){var a=n[o];r[a]={};var s=JSON.parse("["+t[a].sessionKey+"]");r[a].sessionKey=new Uint8Array(s),r[a].isToEncrypt=t[a].isToEncrypt}}catch(e){M.error("_chatkeysToArrayCloner:err",e)}return r}Object.defineProperty(t,"__esModule",{value:!0});var n=r(40),i=_interopRequireDefault(n),o=r(41),a=_interopRequireDefault(o),s=r(96),u=_interopRequireDefault(s),c=r(12),f=_interopRequireDefault(c),l=r(1),d=_interopRequireDefault(l),p=r(2),y=_interopRequireDefault(p),h=r(11),v=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t}(h),g=r(15),b=r(466),m=_interopRequireDefault(b),_=r(467),R=_interopRequireDefault(_),w=r(469),S=_interopRequireDefault(w),O=r(201),M=v.getLogger("IdentityModule"),P=function(){/**
  * This is the constructor to initialise the Identity Module it does not require any input.
  */
function IdentityModule(e,t,r,n,i){(0,d.default)(this,IdentityModule);var o=this;if(!e)throw new Error("runtimeURL is missing.");if(!r)throw new Error("storageManager is missing");if(!i)throw new Error("runtimeFactory is missing");o._runtimeURL=e,o.storageManager=r,o.dataObjectsStorage=n,o._idmURL=o._runtimeURL+"/idm",o._guiURL=o._runtimeURL+"/identity-gui",o.runtimeCapabilities=t,o.runtimeFactory=i,o._domain=(0,g.divideURL)(o._runtimeURL).domain,o.watchingYou=new O.WatchingYou,
//to store items with this format: {identity: identityURL, token: tokenID}
o.identities=[],o.identitiesList=o.watchingYou.watch("identitiesList",{},!0),o.emailsList=[];var a=new m.default("guid","HUMAN");o.identity=a,o.crypto=new R.default(o.runtimeFactory),o.currentIdentity,o.defaultIdentity,
//stores the association of the dataObject and the Hyperty registered within
o.dataObjectsIdentity={},
// hashTable to store all the crypto information between two hyperties
o.chatKeys={},
// hashTable to store the symmetric keys to be used in the chat group
o.dataObjectSessionKeys={},
//failsafe to enable/disable all the criptographic functions
o.isToUseEncryption=!0,
...
/**
  ...
  */
return(0,y.default)(IdentityModule,[{key:"getIdentity",
...
/**
    ...
    */
value:function(e){var t=this;for(var r in t.identities){var n=t.identities[r];if(n.identity===e)return n}throw"identity not found"}},{key:"setCurrentIdentity",value:function(e){this.currentIdentity=e}},{key:"getIdentities",value:function(){return this.identities}},{key:"getIdentitiesToChoose",value:function(){return{identities:this.emailsList,idps:[{domain:"google.com",type:"idToken"},{domain:"microsoft.com",type:"idToken"},{domain:"slack.com",type:"Legacy"}]}}},{key:"getCurrentIdentity",value:function(){return this.currentIdentity}},{key:"loadIdentities",value:function(){var e=this;return new f.default(function(t){e.storageManager.get("idModule:identities").then(function(r){r&&(e.identities=r,r.forEach(function(t){var r=e._secondsSinceEpoch(),n=0;t.info&&t.info.expires?n=t.info.expires:t.info&&t.info.tokenIDJSON&&t.info.tokenIDJSON.exp&&(n=t.info.tokenIDJSON.exp),t.hasOwnProperty("interworking")||t.interworking||(e.defaultIdentity=t.messageInfo,parseInt(n)>r&&(e.defaultIdentity.expires=parseInt(n),e.currentIdentity=e.defaultIdentity))})),t()})})}},{key:"getIdentityAssertion",value:function(e){M.log("[getIdentityAssertion:identityBundle]",e);var t=this;return new f.default(function(r,n){
//CHECK whether is browser environment or nodejs
//if it is browser, then create a fake identity
t.runtimeCapabilities.isAvailable("browser").then(function(i){if(M.log("runtime browser identity acquisition",i),i)
//todo: only idp should be mandatory when identityBundle exists
if(e&&e.hasOwnProperty("idp")){var o=e.idp,a=e.hasOwnProperty("origin")?e.origin:"origin",s=e.hasOwnProperty("idHint")?e.idHint:"";t.selectIdentityForHyperty(a,o,s).then(function(e){return M.log("[IdentityModule] Identity selected by hyperty."),r(e)},function(e){
// if it got an error then just select identity from GUI
// console.error('[IdentityModule] Could not select identity from hyperty.');
t.selectIdentityFromGUI().then(function(e){return M.log("[IdentityModule] Identity selected by hyperty."),r(e)},function(e){return n(e)})})}else{if(t.defaultIdentity&&t.defaultIdentity.expires>t._secondsSinceEpoch())return r(t.defaultIdentity);t.selectIdentityFromGUI().then(function(e){return M.log("[IdentityModule] Identity selected from GUI."),e.hasOwnProperty("messageInfo")?(t.defaultIdentity=e.messageInfo,r(e.messageInfo)):(t.defaultIdentity=e,r(e))},function(e){return n(e)})}}).catch(function(e){return n(e)}),t.runtimeCapabilities.isAvailable("node").then(function(e){if(M.log("node identity acquisition",e),e){if(void 0!==t.currentIdentity)
//TODO verify whether the token is still valid or not.
// should be needed to make further requests, to obtain a valid token
return r(t.currentIdentity);M.log("getIdentityAssertion for nodejs");var i={type:"idp",value:"nodejs-idp",code:200,auth:!1};t.callNodeJsGenerateMethods(i.value,"origin").then(function(e){r(e)},function(e){n(e)})}}).catch(function(e){n(e)})})}},{key:"getUsersIDs",value:function(e){M.log("[getUsersIDs:emailFormat]",e),M.log("getUsersIDs:emailFormat",e);var t=this,r=[],n=e?g.getUserEmailFromURL:function(e){return e};for(var i in t.identities){var o=t.identities[i];r.push(n(o.identity))}return r}},{key:"deleteIdentity",value:function(e){var t=this;
//let userURL = convertToUserURL(userID);
for(var r in t.identities)t.identities[r].identity===e&&t.identities.splice(r,1)}},{key:"unregisterIdentity",value:function(e){var t=this;for(var r in t.emailsList)t.emailsList[r]===e&&t.emailsList.splice(r,1)}},{key:"requestIdentityToGUI",value:function(e,t){M.log("[requestIdentityToGUI:identities]",e),M.log("[requestIdentityToGUI:idps]",t);var r=this;return new f.default(function(n,i){
//condition to check if the real GUI is deployed. If not, deploys a fake gui
if(!1===r.guiDeployed){var o=r._guiURL,a=new S.default(o,r._messageBus);r.guiFake=a,r.guiDeployed=!0}var s={type:"create",to:r._guiURL,from:r._idmURL,body:{value:{identities:e,idps:t}}},u=r._messageBus.postMessage(s);
...
if(r._messageBus.removeResponseListener(r._idmURL,u),200===e.body.code){var t=e.body;M.log("selectedIdentity: ",t.value),n(t)}else i("error on requesting an identity to the GUI")})}catch(e){i("In method callIdentityModuleFunc error: "+e)}})}},{key:"callNodeJsGenerateMethods",value:function(e,t){M.log("[callNodeJsGenerateMethods:idp]",e),M.log("[callNodeJsGenerateMethods:origin]",t);var r=this;return new f.default(function(n,i){
//debugger;
var o=void 0,a=void 0;
//generates the RSA key pair
r.crypto.generateRSAKeyPair().then(function(n){M.log("[callNodeJsGenerateMethods:keyPair.public]",n.public),o=r.crypto.encode(n.public),a=n,
...
n.loginSelectedIdentity(publicKey,e,t,a,r.loginUrl).then(function(e){return i(e)},function(e){return o(e)}):(
...
M.log("Proceeding by logging in."),n.generateSelectedIdentity(publicKey,e,t,a).then(function(e){return i(e)},function(e){return o(e)}))}).catch(function(e){o("On selectIdentityForHyperty from method sendGenerateMessage error:  "+e)})}).catch(function(e){o("On selectIdentityForHyperty from method generateRSAKeyPair error:  "+e)})})}},{key:"selectIdentityFromGUI",value:function(e){M.log("[selectIdentityFromGUI:origin]",e);var t=this;return new f.default(function(r,n){var i=t.getIdentitiesToChoose();t.requestIdentityToGUI(i.identities,i.idps).then(function(i){if("identity"===i.type){
...
for(var a in t.identities)if(t.identities[a].identity===o)return r(t.identities[a].messageInfo);return n("no identity was found .")}if("idp"!==i.type)return n("error on GUI received message.");t.callGenerateMethods(i.value,e).then(function(e){return r(e)},function(e){return n(e)})}).catch(function(e){n("On selectIdentityFromGUI from method requestIdentityToGUI error:  "+e)})})}},{key:"storeIdentity",value:function(e,t){M.log("[storeIdentity:result]",e),M.log("[storeIdentity:keyPair]",t);var r=this;return new f.default(function(n,i){if(!e.hasOwnProperty("assertion"))return i("StoreIdentity: input is not an identity assertion.");var o=e.assertion.split("."),a=void 0;
//verify if the token contains the 3 components, or just the assertion
try{a=o[1]?r.crypto.decode(o[1]):r.crypto.decode(e.assertion)}catch(e){return i("In storeIdentity, error parsing assertion: "+e)}var s=void 0;
//TODO remove the verification and remove the tokenIDJSON from the google idpProxy;
s=a.tokenIDJSON?a.tokenIDJSON:a,s.idp=e.idp;var c=s.email||s.sub,f="user://"+s.idp.domain+"/"+c;e.identity=f,r.identity.addIdentity(e);
// check if exists any infoToken in the result received
var l=e.infoToken?e.infoToken:{},d=s.name||c.substring(0,c.indexOf("@")),p={username:c,cn:d,avatar:l.picture,locale:l.locale,userURL:f},y=void 0;l.hasOwnProperty("exp")?y=l.exp:e.hasOwnProperty("info")&&e.info.hasOwnProperty("expires")&&(y=e.info.expires);
...
g=(0,u.default)(g,e),n(g.messageInfo);var m=!1;
...
for(var _ in r.emailsList)if(r.emailsList[_]===c){m=!0;break}m||r.emailsList.push(c)}else r.emailsList.push(c),r.identities.push(e);r.storageManager.set("idModule:identities",0,r.identities).then(function(){r.identitiesList[s.idp.domain]&&(r.identitiesList[s.idp.domain].status="created"),M.log("storeIdentity:newID",h),n(h)}).catch(function(e){i("On _sendReporterSessionKey from method storeIdentity error: "+e)})})}},{key:"generateSelectedIdentity",value:function(e,t,r,n){M.log("[generateSelectedIdentity:publicKey]",e),M.log("[generateSelectedIdentity:origin]",t),M.log("[generateSelectedIdentity:idp]",r),M.log("[generateSelectedIdentity:keyPair]",n);var i=this;return new f.default(function(o,a){M.log("[IdentityModule:generateSelectedIdentity] NO_URL"),i.generateAssertion(e,t,"",n,r).then(function(e){return e}).then(function(o){return M.log("[IdentityModule:generateSelectedIdentity] URL"),i.generateAssertion(e,t,o,n,r)}).then(function(e){return e?o(e):a("Error on obtaining Identity")}).catch(function(e){return a(e)})})}},{key:"callIdentityModuleFunc",value:function(e,t){M.log("[callIdentityModuleFunc:methodName]",e),M.log("[callIdentityModuleFunc:parameters]",t);var r=this;return new f.default(function(n,i){var o={type:"execute",to:r._guiURL,from:r._idmURL,body:{resource:"identity",method:e,params:t}},a=r._messageBus.postMessage(o);
//add listener without timout
try{r._messageBus.addResponseListener(r._idmURL,a,function(e){r._messageBus.removeResponseListener(r._idmURL,a);var t=e.body.value;n(t)})}catch(e){i("In method callIdentityModuleFunc error: "+e)}})}},{key:"encryptMessage",value:function(e){
//console.info('encryptMessage:message', message);
var t=this;return M.log("encrypt message "),new f.default(function(r,n){var i="handshake"===e.type;
//if is not to apply encryption, then returns resolve
if(!t.isToUseEncryption&&!i)return r(e);var o=t._parseMessageURL(e.to),s=(0,g.isDataObjectURL)(o),u=(0,g.isLegacy)(e.to),c="hyperty"===(0,g.divideURL)(e.from).type,f="hyperty"===(0,g.divideURL)(e.to).type;if("update"===e.type)return M.log("encrypt message: message type update"),r(e);if(u)r(e);else if(c&&f){var l=t._registry.getHypertyOwner(e.from);if(l){
// check if exists any keys between two users
var d=t.chatKeys[e.from+"<->"+e.to];if(d||(d=t._newChatCrypto(e,l),
//log.log('createChatKey encrypt', message.from + message.to);
t.chatKeys[e.from+"<->"+e.to]=d,e.body.handshakePhase="startHandShake"),d.authenticated&&!i){var p=t.crypto.generateIV();t.crypto.encryptAES(d.keys.hypertyFromSessionKey,e.body.value,p).then(function(n){var i=t._filterMessageToHash(e,(0,a.default)(e.body.value)+(0,a.default)(p),d.hypertyFrom.messageInfo);t.crypto.hashHMAC(d.keys.hypertyFromHashKey,i).then(function(i){
//log.log('result of hash ', hash);
var o={iv:t.crypto.encode(p),value:t.crypto.encode(n),hash:t.crypto.encode(i)};e.body.value=t.crypto.encode(o),r(e)})})}else i?r(e):t._doHandShakePhase(e,d).then(function(r){t.chatKeys[e.from+"<->"+e.to]=r.chatKeys,t._messageBus.postMessage(r.message),n("encrypt handshake protocol phase ")})}else n("In encryptMessage: Hyperty owner URL was not found")}else c&&s&&
//log.log('dataObject value to encrypt: ', message.body.value);
//log.log('IdentityModule - encrypt from hyperty to dataobject ', message);
t.storageManager.get("dataObjectSessionKeys").then(function(i){i=_chatkeysToArrayCloner(o,i);var s=i?i[o]:null;t.dataObjectsStorage.getDataObject(o).then(function(i){
//if no key exists, create a new one if is the reporter of dataObject
if(!s&&i.reporter&&i.reporter===e.from){var u=t.crypto.generateRandom();t.dataObjectSessionKeys[o]={sessionKey:u,isToEncrypt:!0};var c=_chatkeysToStringCloner(o,t.dataObjectSessionKeys);
//TODO: check if this does not need to be stored
t.storageManager.set("dataObjectSessionKeys",0,c).catch(function(e){n("On encryptMessage from method storageManager.set error: "+e)}),s=t.dataObjectSessionKeys[o]}
//check if there is already a session key for the chat room
if(s)
// and if is to apply encryption, encrypt the messages
if(s.isToEncrypt){var f=t.crypto.generateIV();t.crypto.encryptAES(s.sessionKey,t.crypto.encode(e.body.value),f).then(function(n){delete e.body.identity.assertion,//TODO: Check why assertion is comming on the message!
delete e.body.identity.expires;//TODO: Check why expires is comming on the message!
var i=t._filterMessageToHash(e,(0,a.default)(e.body.value)+(0,a.default)(f));t.crypto.hashHMAC(s.sessionKey,i).then(function(i){
// log.log('hash ', hash);
var o={value:t.crypto.encode(n),iv:t.crypto.encode(f),hash:t.crypto.encode(i)};e.body.value=(0,a.default)(o),r(e)})})}else r(e);else n("Data object key could not be defined: Failed to decrypt message ")}).catch(function(e){n("On encryptMessage from method dataObjectsStorage.getDataObject error: "+e)})}).catch(function(e){n("On encryptMessage from method storageManager.get error: "+e)})})}},{key:"encryptDataObject",value:function(e,t){var r=this;return new f.default(function(n,i){var o=r._parseMessageURL(t);r.storageManager.get("dataObjectSessionKeys").then(function(t){t=_chatkeysToArrayCloner(o,t);var a=t?t[o]:null;
//check if there is already a session key for the chat room
if(!a)return i("No dataObjectKey for this dataObjectURL:",o);
// and if is to apply encryption, encrypt the messages
if(!a.isToEncrypt)return n(e);var s=r.crypto.generateIV();r.crypto.encryptAES(a.sessionKey,r.crypto.encode(e),s).then(function(e){var t={value:r.crypto.encode(e),iv:r.crypto.encode(s)};
...
return new f.default(function(r,n){var i="handshake"===e.type;
//if is not to apply encryption, then returns resolve
if(!t.isToUseEncryption&&!i)
// log.log('decryption disabled');
return r(e);var o=t._parseMessageURL(e.to),s=(0,g.isDataObjectURL)(o),u="hyperty"===(0,g.divideURL)(e.from).type,c="hyperty"===(0,g.divideURL)(e.to).type;if("update"===e.type)return r(e);
//is is hyperty to hyperty communication
if(u&&c){
// log.log('decrypt hyperty to hyperty');
var f=t._registry.getHypertyOwner(e.to);if(f){var l=t.chatKeys[e.to+"<->"+e.from];if(l||(l=t._newChatCrypto(e,f,"decrypt"),t.chatKeys[e.to+"<->"+e.from]=l),l.authenticated&&!i){var d=t.crypto.decode(e.body.value),p=t.crypto.decodeToUint8Array(d.iv),y=t.crypto.decodeToUint8Array(d.value),h=t.crypto.decodeToUint8Array(d.hash);t.crypto.decryptAES(l.keys.hypertyToSessionKey,y,p).then(function(n){
// log.log('decrypted value ', decryptedData);
e.body.value=n;var i=t._filterMessageToHash(e,n+p);t.crypto.verifyHMAC(l.keys.hypertyToHashKey,i,h).then(function(t){
//log.log('result of hash verification! ', result);
e.body.assertedIdentity=!0,r(e)})})}else i?t._doHandShakePhase(e,l).then(function(r){
//if it was started by doMutualAuthentication then ends the protocol
"handShakeEnd"===r||(t.chatKeys[e.to+"<->"+e.from]=r.chatKeys,t._messageBus.postMessage(r.message))}):n("wrong message do decrypt")}else n("error on decrypt message")}else u&&s?
// log.log('dataObject value to decrypt: ', message.body);
t.storageManager.get("dataObjectSessionKeys").then(function(n){n=_chatkeysToArrayCloner(o,n);var i=n?n[o]:null;if(i)
//check if is to apply encryption
if(i.isToEncrypt){var s=JSON.parse(e.body.value),u=t.crypto.decodeToUint8Array(s.iv),c=t.crypto.decodeToUint8Array(s.value),f=t.crypto.decodeToUint8Array(s.hash);t.crypto.decryptAES(i.sessionKey,c,u).then(function(n){var o=t.crypto.decode(n);
// log.log('decrypted Value,', parsedValue);
e.body.value=o;var s=t._filterMessageToHash(e,(0,a.default)(o)+(0,a.default)(u));t.crypto.verifyHMAC(i.sessionKey,s,f).then(function(t){
// log.log('result of hash verification! ', result);
e.body.assertedIdentity=!0,r(e)})})}else e.body.assertedIdentity=!0,r(e);else e.body.assertedIdentity=!0,r(e)}):n("wrong message to decrypt")})}},{key:"decryptDataObject",value:function(e,t){var r=this;return new f.default(function(n,i){
//if is not to apply encryption, then returns resolve
if(!r.isToUseEncryption)
// log.log('decryption disabled');
return n(e);var o=r._parseMessageURL(t);
// log.log('dataObject value to decrypt: ', dataObject);
r.storageManager.get("dataObjectSessionKeys").then(function(t){t=_chatkeysToArrayCloner(o,t);var a=t?t[o]:null;if(!a)return i("No dataObjectKey for this dataObjectURL:",o);
//check if is to apply encryption
if(!a.isToEncrypt)
// log.log('The dataObject is not encrypted');
return n(e);var s=r.crypto.decodeToUint8Array(e.iv),u=r.crypto.decodeToUint8Array(e.value);r.crypto.decryptAES(a.sessionKey,u,s).then(function(e){var t=r.crypto.decode(e),i={value:t,iv:r.crypto.encode(s)};
// log.log('decrypted dataObject,', newValue);
return n(i)}).catch(function(e){i("On decryptDataObject from method encryptAES error: "+e)})})})}},{key:"doMutualAuthentication",value:function(e,t){var r=this;return new f.default(function(n,i){var o=void 0,a=r.registry.getReporterURLSynchonous(e);a&&(o=e,e=a);var s={to:t,from:e,callback:void 0,body:{handshakePhase:"startHandShake",ignore:"ignoreMessage"}};if(!e||!t)return i("sender or receiver missing on doMutualAuthentication");var u=r.chatKeys[e+"<->"+t],c=r._registry.getHypertyOwner(e);if(c){if(!u){
// callback to resolve when finish the mutual authentication
var f=function(e){
// log.log('callback value:', value);
n(e)};s.callback=f,s.dataObjectURL=o,u=r._newChatCrypto(s,c),r.chatKeys[e+"<->"+t]=u}if(u.authenticated){var l={to:e,from:t};u.dataObjectURL=o,r._sendReporterSessionKey(l,u).then(function(e){r._messageBus.postMessage(e.message),n("exchange of chat sessionKey initiated")}).catch(function(e){i("On doMutualAuthentication from method _sendReporterSessionKey error: "+e)})}else r._doHandShakePhase(s,u)}else i("Mutual authentication error: Hyperty owner could not be resolved")})}},{key:"getToken",value:function(e,t){var r=this;return new f.default(function(n,i){
// log.log('[Identity.IdentityModule.getToken] from->', fromURL, '  to->', toUrl);
t?
//log.log('toUrl', toUrl);
r.registry.isLegacy(t).then(function(o){
...
var a=r.getAccessToken(t);if(a)return n(a);var s=(0,g.getUserIdentityDomain)(t);
...
var o=r.getAccessToken(t);return o?n(o):i("No Access token found")},function(e){return i(e)}))}else r._getValidToken(e).then(function(e){n(e)}).catch(function(e){i("On getToken from method _getValidToken error: "+e)})}).catch(function(e){i("On getToken from method isLegacy error: "+e)}):r._getValidToken(e).then(function(e){n(e)})})}},{key:"getIdToken",value:function(e){var t=this;return new f.default(function(r,n){if("hyperty"!==e.split("://")[0])t._getHypertyFromDataObject(e).then(function(e){var i=t.registry.getHypertyOwner(e);if(!i)return n("no identity was found ");for(var o in t.identities){var a=t.identities[o];if(a.identity===i)return r(a.messageInfo)}}).catch(function(e){n(e)});else{var i=t.registry.getHypertyOwner(e);if(!i)return n("no identity was found.");for(var o in t.identities){var a=t.identities[o];if(a.identity===i)
// TODO check this getIdToken when we run on nodejs environment;
// TODO check this getIdToken when we run on nodejs environment;
//hack while idm is not reestuctured
return a.hasOwnProperty("messageInfo")?a.messageInfo.hasOwnProperty("assertion")?r(a.messageInfo):(a.messageInfo.assertion=a.assertion,r(a.messageInfo)):r(a)}}})}},{key:"getAccessToken",value:function(e){var t=this,r=(0,g.divideURL)(e).domain;e.includes("protostub")&&(r=r.replace(r.split(".")[0]+".",""));var n=void 0,i=void 0,o=t._secondsSinceEpoch();for(var a in t.identities){var s=t.identities[a];if(s.hasOwnProperty("interworking")&&s.interworking.domain===r)
// check if there is expiration time
// check if there is expiration time
// else this access token has no expiration time
return s.hasOwnProperty("info")&&s.info.hasOwnProperty("expires")&&(i=s.info.expires,M.log("[Identity.IdentityModule.getAccessToken] Token expires in",i),M.log("[Identity.IdentityModule.getAccessToken] time now:",o),o>=i)?null:(s.hasOwnProperty("messageInfo")&&s.messageInfo.hasOwnProperty("userProfile")&&s.messageInfo.userProfile&&(n={userProfile:s.messageInfo.userProfile,access_token:s.interworking.access_token},s.hasOwnProperty("infoToken")&&s.infoToken.hasOwnProperty("id")&&(n.userProfile.id=s.infoToken.id)),n)}return null}},{key:"loadSessionKeys",value:function(){var e=this;return new f.default(function(t){e.storageManager.get("dataObjectSessionKeys").then(function(r){
...
e.dataObjectSessionKeys=r||{},t()})})}},{key:"sendRefreshMessage",value:function(e){var t=this;t._resolveDomain(e.idp),t.getIdentity(e.userProfile.userURL);return M.log("sendRefreshMessage:oldIdentity",e),new f.default(function(r,n){var i=t._resolveDomain(e.idp),o=void 0,a=t.getIdentity(e.userProfile.userURL);o={type:"execute",to:i,from:t._idmURL,body:{resource:"identity",method:"refreshAssertion",params:{identity:a}}};try{t._messageBus.postMessage(o,function(e){var t=e.body.value;r(t)})}catch(e){n("In sendRefreshMessage on postMessage error: "+e)}})}},{key:"sendGenerateMessage",value:function(e,t,r,n){M.log("[sendGenerateMessage:contents]",e),M.log("[sendGenerateMessage:origin]",t),M.log("[sendGenerateMessage:usernameHint]",r),M.log("[sendGenerateMessage:idpDomain]",n),M.log("sendGenerateMessage_hint");var i=this;return new f.default(function(o,a){var s=i._resolveDomain(n),u=void 0;u={type:"execute",to:s,from:i._idmURL,body:{resource:"identity",method:"generateAssertion",params:{contents:e,origin:t,usernameHint:r}}};try{i._messageBus.postMessage(u,function(e){var t=e.body.value;o(t)})}catch(e){a("In sendRefreshMessage on postMessage error: "+e)}})}},{key:"generateAssertion",value:function(e,t,r,n,i){M.log("[generateAssertion:contents]",e),M.log("[generateAssertion:origin]",t),M.log("[generateAssertion:usernameHint]",r),M.log("[generateAssertion:keyPair]",n),M.log("[generateAssertion:idpDomain]",i);var o=this;return new f.default(function(a,s){M.log("[IdentityModule:generateSelectedIdentity:sendGenerateMessage]",r),o.sendGenerateMessage(e,t,r,i).then(function(e){e.loginUrl?o.callIdentityModuleFunc("openPopup",{urlreceived:e.loginUrl}).then(function(e){M.log("[IdentityModule:generateSelectedIdentity:openPopup]",r),a(e)},function(e){s(e)}):e?o.storeIdentity(e,n).then(function(e){a(e)},function(e){s(e)}):s("error on obtaining identity information")}).catch(function(e){s("On generateAssertion from method sendGenerateMessage error: "+e)})})}},{key:"validateAssertion",value:function(e,t,r){M.log("[validateAssertion:assertion]",e),M.log("[validateAssertion:origin]",t),M.log("[validateAssertion:idpDomain]",r);var n=this,i=n._resolveDomain(r),o={type:"execute",to:i,from:n._idmURL,body:{resource:"identity",method:"validateAssertion",params:{assertion:e,origin:t}}};return new f.default(function(e,t){try{n._messageBus.postMessage(o,function(r){200===r.body.code?e(r.body.value):t("error",r.body.code)})}catch(e){t("On validateAssertion from method postMessage error: "+e)}})}},{key:"addGUIListeners",value:function(){var e=this;e._messageBus.addListener(e._idmURL,function(t){var r=t.body.method,n=void 0;if("deployGUI"===r)n=e.deployGUI();else if("getIdentitiesToChoose"===r)n=e.getIdentitiesToChoose();else if("unregisterIdentity"===r){var i=t.body.params.email;n=e.unregisterIdentity(i)}else{if("generateRSAKeyPair"===r)
// because generateRSAKeyPair is a promise
// we have to send the message only after getting the key pair
return void e.crypto.generateRSAKeyPair().then(function(r){var n={type:"execute",value:r,code:200},i={id:t.id,type:"response",to:t.from,from:t.to,body:n};try{e._messageBus.postMessage(i)}catch(e){reject("On addGUIListeners from if generateRSAKeyPair method postMessage error: "+e)}});if("sendGenerateMessage"===r){var o=t.body.params.contents,a=t.body.params.origin,s=t.body.params.usernameHint,u=t.body.params.idpDomain;return void e.sendGenerateMessage(o,a,s,u).then(function(r){var n={type:"execute",value:r,code:200},i={id:t.id,type:"response",to:t.from,from:t.to,body:n};try{e._messageBus.postMessage(i)}catch(e){reject("On addGUIListeners from if sendGenerateMessage method postMessage error: "+e)}})}if("storeIdentity"===r){var c=t.body.params.result,f=t.body.params.keyPair;return void e.storeIdentity(c,f).then(function(r){var n={type:"execute",value:r,code:200},i={id:t.id,type:"response",to:t.from,from:t.to,body:n};try{e._messageBus.postMessage(i)}catch(e){reject("On addGUIListeners from if storeIdentity method postMessage error: "+e)}})}}/*else if (funcName === 'selectIdentityForHyperty') {
...
var l={type:"execute",value:n,code:200},d={id:t.id,type:"response",to:t.from,from:t.to,body:l};try{e._messageBus.postMessage(d)}catch(e){reject("On addGUIListeners from if storeIdentity method postMessage error: "+e)}})}},{key:"deployGUI",value:function(){this.guiDeployed=!0}},{key:"_getValidToken",value:function(e){
//  console.info('_getValidToken:hypertyURL', hypertyURL);
var t=this;return new f.default(function(r,n){t.getIdToken(e).then(function(e){
//        log.log('[Identity.IdentityModule.getValidToken] Token', identity);
var i=t._secondsSinceEpoch(),o=t.getIdentity(e.userProfile.userURL),a=void 0;o.hasOwnProperty("info")?o.info.hasOwnProperty("expires")?a=o.info.expires:o.info.hasOwnProperty("tokenIDJSON")?a=o.info.tokenIDJSON.exp:r(e):o.hasOwnProperty("infoToken")&&o.infoToken.hasOwnProperty("exp")?a=o.infoToken.exp:r(e),M.log("[Identity.IdentityModule.getValidToken] Token expires in",a),M.log("[Identity.IdentityModule.getValidToken] time now:",i),i>=a?"google.com"===e.idp?t.sendRefreshMessage(e).then(function(e){t.deleteIdentity(o.identity),t.storeIdentity(e,o.keyPair).then(function(e){r(e)},function(e){n(e)})}):(
// microsoft.com
t.deleteIdentity(o.identity),
// generate new idToken
t.callGenerateMethods(e.idp).then(function(e){r(e)}).catch(function(e){n("On addGUIListeners from if storeIdentity method postMessage error: "+e)})):r(e)}).catch(function(e){n(e)})})}},{key:"_getHypertyFromDataObject",value:function(e){var t=this;return new f.default(function(r,n){var i=(0,g.divideURL)(e),o=i.domain,a=t._parseMessageURL(e),s=t.registry.getReporterURLSynchonous(a);if(s)r(s);else{
// check if there is already an association from an hypertyURL to the dataObject
var u=t.dataObjectsIdentity[a];if(u)r(u);else{
// check if there is any hyperty that subscribed the dataObjectURL
var c=t.registry.getDataObjectSubscriberHyperty(e);c?r(c):
// search in domain registry for the hyperty associated to the dataObject
// search in case is a subscriber who wants to know the reporter
t._coreDiscovery.discoverDataObjectPerURL(a,o).then(function(e){t.dataObjectsIdentity[a]=e.reporter,r(e.reporter)},function(e){n(e)})}}})}},{key:"_sendReporterSessionKey",value:function(e,t){var r=this;return new f.default(function(n,i){var o=r.dataObjectSessionKeys[t.dataObjectURL],a=void 0,s=void 0,u=void 0,c=void 0,f={};
//if there is not yet a session Key, generates a new one
if(o)u=o.sessionKey;else{u=r.crypto.generateRandom(),r.dataObjectSessionKeys[t.dataObjectURL]={sessionKey:u,isToEncrypt:!0};var l=_chatkeysToStringCloner(t.dataObjectURL,r.dataObjectSessionKeys);r.storageManager.set("dataObjectSessionKeys",0,l).catch(function(e){i("On _sendReporterSessionKey from method storageManager.set(dataObjectSessionKeys...) error: "+e)})}try{s=r.crypto.encode({value:r.crypto.encode(u),dataObjectURL:t.dataObjectURL})}catch(e){return i("On _sendReporterSessionKey from method storageManager.set error valueToEncrypt: "+e)}c=r.crypto.generateIV(),f.iv=r.crypto.encode(c),r.crypto.encryptAES(t.keys.hypertyFromSessionKey,s,c).then(function(n){a={type:"handshake",to:e.from,from:e.to,body:{handshakePhase:"reporterSessionKey",value:r.crypto.encode(n)}};var i=r._filterMessageToHash(a,s+c,t.hypertyFrom.messageInfo);return r.crypto.hashHMAC(t.keys.hypertyFromHashKey,i)}).then(function(e){var i=r.crypto.encode({value:a.body.value,hash:r.crypto.encode(e),iv:f.iv});a.body.value=i,n({message:a,chatKeys:t})}).catch(function(e){i("On _sendReporterSessionKey from chained promises encryptAES error: "+e)})})}},{key:"_resolveDomain",value:function(e){return e?"domain-idp://"+e:"domain-idp://google.com"}},{key:"_doHandShakePhase",value:function(e,t){
// log('_doHandShakePhase:dataObject', message);
//	log('_doHandShakePhase:chatKeys', chatKeys);
var r=this;return new f.default(function(n,i){var o=e.body.handshakePhase,a=void 0,s=void 0,u={},c=void 0;switch(o){case"startHandShake":t.keys.fromRandom=r.crypto.generateRandom();var f={type:"handshake",to:e.to,from:e.from,body:{handshakePhase:"senderHello",value:r.crypto.encode(t.keys.fromRandom)}};t.handshakeHistory.senderHello=r._filterMessageToHash(f,void 0,t.hypertyFrom.messageInfo),
// check if was the encrypt function or the mutual authentication that request the
// start of the handShakePhase.
t.initialMessage?n({message:f,chatKeys:t}):(r.chatKeys[e.from+"<->"+e.to]=t,r._messageBus.postMessage(f));break;case"senderHello":M.log("senderHello"),t.handshakeHistory.senderHello=r._filterMessageToHash(e),t.keys.fromRandom=r.crypto.decodeToUint8Array(e.body.value),t.keys.toRandom=r.crypto.generateRandom();var l={type:"handshake",to:e.from,from:e.to,body:{handshakePhase:"receiverHello",value:r.crypto.encode(t.keys.toRandom)}};t.handshakeHistory.receiverHello=r._filterMessageToHash(l,void 0,t.hypertyFrom.messageInfo),n({message:l,chatKeys:t});break;case"receiverHello":M.log("receiverHello"),t.handshakeHistory.receiverHello=r._filterMessageToHash(e),r.validateAssertion(e.body.identity.assertion,void 0,e.body.identity.idp).then(function(n){
//TODO remove later this verification as soon as all the IdP proxy are updated in the example
var i="string"==typeof n.contents?n.contents:n.contents.nonce,o=r.crypto.decodeToUint8Array(i),a=r.crypto.generatePMS(),s=e.body.value;t.hypertyTo.assertion=e.body.identity.assertion,t.hypertyTo.publicKey=o,t.hypertyTo.userID=n.contents.email,t.keys.toRandom=r.crypto.decodeToUint8Array(s),t.keys.premasterKey=a;var u=r.crypto.concatPMSwithRandoms(a,t.keys.toRandom,t.keys.fromRandom);return r.crypto.generateMasterSecret(u,"messageHistoric"+t.keys.toRandom+t.keys.fromRandom)}).then(function(e){return t.keys.masterKey=e,r.crypto.generateKeys(e,"key expansion"+t.keys.toRandom+t.keys.fromRandom)}).then(function(n){t.keys.hypertyToSessionKey=new Uint8Array(n[0]),t.keys.hypertyFromSessionKey=new Uint8Array(n[1]),t.keys.hypertyToHashKey=new Uint8Array(n[2]),t.keys.hypertyFromHashKey=new Uint8Array(n[3]),a=r.crypto.generateIV(),u.iv=r.crypto.encode(a);var i={type:"handshake",to:e.from,from:e.to,body:{handshakePhase:"senderCertificate"}};
// hash the value and the iv
return c=r._filterMessageToHash(i,"ok"+a,t.hypertyFrom.messageInfo),r.crypto.hashHMAC(t.keys.hypertyFromHashKey,c)}).then(function(e){
//encrypt the data
return u.hash=r.crypto.encode(e),r.crypto.encryptAES(t.keys.hypertyFromSessionKey,"ok",a)}).then(function(e){return u.symetricEncryption=r.crypto.encode(e),r.crypto.encryptRSA(t.hypertyTo.publicKey,t.keys.premasterKey)}).then(function(n){u.assymetricEncryption=r.crypto.encode(n);var i={type:"handshake",to:e.from,from:e.to,body:{handshakePhase:"senderCertificate"}},o=r._filterMessageToHash(i,t.keys.premasterKey,t.hypertyFrom.messageInfo);return r.crypto.signRSA(t.hypertyFrom.privateKey,r.crypto.encode(t.handshakeHistory)+r.crypto.encode(o))}).then(function(i){u.signature=r.crypto.encode(i);var o={type:"handshake",to:e.from,from:e.to,body:{handshakePhase:"senderCertificate",value:r.crypto.encode(u)}};t.handshakeHistory.senderCertificate=r._filterMessageToHash(o,"ok"+a,t.hypertyFrom.messageInfo),n({message:o,chatKeys:t})},function(e){return i(e)});break;case"senderCertificate":M.log("senderCertificate");var d=r.crypto.decode(e.body.value);r.validateAssertion(e.body.identity.assertion,void 0,e.body.identity.idp).then(function(n){var i=r.crypto.decodeToUint8Array(d.assymetricEncryption),o="string"==typeof n.contents?n.contents:n.contents.nonce,a=r.crypto.decodeToUint8Array(o);return t.hypertyTo.assertion=e.body.identity.assertion,t.hypertyTo.publicKey=a,t.hypertyTo.userID=n.contents.email,r.crypto.decryptRSA(t.hypertyFrom.privateKey,i)},function(e){
// log.log(error);
i("Error during authentication of identity")}).then(function(n){t.keys.premasterKey=new Uint8Array(n);var i=r.crypto.decodeToUint8Array(d.signature),o=r._filterMessageToHash(e,t.keys.premasterKey);return r.crypto.verifyRSA(t.hypertyTo.publicKey,r.crypto.encode(t.handshakeHistory)+r.crypto.encode(o),i)}).then(function(e){
//log.log('SenderCertificate - signature validation result ', signValidationResult);
var n=r.crypto.concatPMSwithRandoms(t.keys.premasterKey,t.keys.toRandom,t.keys.fromRandom);return r.crypto.generateMasterSecret(n,"messageHistoric"+t.keys.toRandom+t.keys.fromRandom)}).then(function(e){return t.keys.masterKey=e,r.crypto.generateKeys(e,"key expansion"+t.keys.toRandom+t.keys.fromRandom)}).then(function(e){t.keys.hypertyFromSessionKey=new Uint8Array(e[0]),t.keys.hypertyToSessionKey=new Uint8Array(e[1]),t.keys.hypertyFromHashKey=new Uint8Array(e[2]),t.keys.hypertyToHashKey=new Uint8Array(e[3]),a=r.crypto.decodeToUint8Array(d.iv);var n=r.crypto.decodeToUint8Array(d.symetricEncryption);return r.crypto.decryptAES(t.keys.hypertyToSessionKey,n,a)}).then(function(n){
// log.log('decryptedData', decryptedData);
t.handshakeHistory.senderCertificate=r._filterMessageToHash(e,n+a);var i=r.crypto.decodeToUint8Array(d.hash);return c=r._filterMessageToHash(e,n+a),r.crypto.verifyHMAC(t.keys.hypertyToHashKey,c,i)}).then(function(n){
...
return a=r.crypto.generateIV(),u.iv=r.crypto.encode(a),c=r._filterMessageToHash(i,"ok!"+a,t.hypertyFrom.messageInfo),r.crypto.hashHMAC(t.keys.hypertyFromHashKey,c)}).then(function(e){return u.hash=r.crypto.encode(e),r.crypto.encryptAES(t.keys.hypertyFromSessionKey,"ok!",a)}).then(function(i){u.value=r.crypto.encode(i);var o={type:"handshake",to:e.from,from:e.to,body:{handshakePhase:"receiverFinishedMessage",value:r.crypto.encode(u)}};t.handshakeHistory.receiverFinishedMessage=r._filterMessageToHash(o,"ok!"+a,t.hypertyFrom.messageInfo),t.authenticated=!0,n({message:o,chatKeys:t})}).catch(function(e){i("On _doHandShakePhase from senderCertificate error: "+e)});break;case"receiverFinishedMessage":t.authenticated=!0,u=r.crypto.decode(e.body.value),a=r.crypto.decodeToUint8Array(u.iv);var p=r.crypto.decodeToUint8Array(u.value);s=r.crypto.decodeToUint8Array(u.hash),r.crypto.decryptAES(t.keys.hypertyToSessionKey,p,a).then(function(o){
// log.log('decryptedData', decryptedData);
t.handshakeHistory.receiverFinishedMessage=r._filterMessageToHash(e,o+a);var u=r._filterMessageToHash(e,o+a);r.crypto.verifyHMAC(t.keys.hypertyToHashKey,u,s).then(function(o){
// check if there was an initial message that was blocked and send it
if(t.initialMessage){var a={type:"create",to:e.from,from:e.to,body:{value:t.initialMessage.body.value}};n({message:a,chatKeys:t})}else r._sendReporterSessionKey(e,t).then(function(e){n(e)}).catch(function(e){i("On _doHandShakePhase from receiverFinishedMessage error: "+e)})})});break;case"reporterSessionKey":M.log("reporterSessionKey");var y=r.crypto.decode(e.body.value);s=r.crypto.decodeToUint8Array(y.hash),a=r.crypto.decodeToUint8Array(y.iv);var h=r.crypto.decodeToUint8Array(y.value),v=void 0,g=void 0,b=void 0,m=void 0;
//log.log('[IdentityModule reporterSessionKey] - decryptAES: ', chatKeys.keys.hypertyToSessionKey, encryptedValue, iv);
r.crypto.decryptAES(t.keys.hypertyToSessionKey,h,a).then(function(n){v=r.crypto.decode(n),g=r.crypto.decodeToUint8Array(v.value),b=v.dataObjectURL;var i=r._filterMessageToHash(e,n+a);return r.crypto.verifyHMAC(t.keys.hypertyToHashKey,i,s)}).then(function(e){
// log.log('hash successfully validated ', hashResult);
r.dataObjectSessionKeys[b]={sessionKey:g,isToEncrypt:!0};var n=_chatkeysToStringCloner(b,r.dataObjectSessionKeys);return r.storageManager.set("dataObjectSessionKeys",0,n).catch(function(e){i("On _sendReporterSessionKey from method reporterSessionKey error: "+e)}),a=r.crypto.generateIV(),u.iv=r.crypto.encode(a),r.crypto.encryptAES(t.keys.hypertyFromSessionKey,"ok!!",a)}).then(function(n){m={type:"handshake",to:e.from,from:e.to,body:{handshakePhase:"receiverAcknowledge"}},u.value=r.crypto.encode(n);var i=r._filterMessageToHash(m,"ok!!"+a,t.hypertyFrom.messageInfo);return r.crypto.hashHMAC(t.keys.hypertyFromHashKey,i)}).then(function(e){var i=r.crypto.encode({value:u.value,hash:r.crypto.encode(e),iv:u.iv});m.body.value=i,n({message:m,chatKeys:t})}).catch(function(e){i("On _doHandShakePhase from reporterSessionKey error: "+e)});break;case"receiverAcknowledge":M.log("receiverAcknowledge");var _=r.crypto.decode(e.body.value),R=r.crypto.decodeToUint8Array(_.hash);a=r.crypto.decodeToUint8Array(_.iv);var w=r.crypto.decodeToUint8Array(_.value);r.crypto.decryptAES(t.keys.hypertyToSessionKey,w,a).then(function(n){var i=r._filterMessageToHash(e,n+a);return r.crypto.verifyHMAC(t.keys.hypertyToHashKey,i,R)}).then(function(e){
// log.log('hashResult ', hashResult);
var r=t.callback;r&&r("handShakeEnd"),n("handShakeEnd")}).catch(function(e){i("On _doHandShakePhase from receiverAcknowledge error: "+e)});break;default:i(e)}})}},{key:"_filterMessageToHash",value:function(e,t,r){return{type:e.type,from:e.from,to:e.to,body:{identity:r||e.body.identity,value:t||e.body.value,handshakePhase:e.body.handshakePhase}}}},{key:"_newChatCrypto",value:function(e,t,r){var n=this,i=r?e.to:e.from,o=r?e.from:e.to,a=n.getIdentity(t);return{hypertyFrom:{hyperty:i,userID:a.messageInfo.userProfile.username,privateKey:a.keyPair.private,publicKey:a.keyPair.public,assertion:a.assertion,messageInfo:a.messageInfo},hypertyTo:{hyperty:o,userID:void 0,publicKey:void 0,assertion:void 0},keys:{hypertyToSessionKey:void 0,hypertyFromSessionKey:void 0,hypertyToHashKey:void 0,hypertyFromHashKey:void 0,toRandom:void 0,fromRandom:void 0,premasterKey:void 0,masterKey:void 0},handshakeHistory:{senderHello:void 0,receiverHello:void 0,senderCertificate:void 0,receiverFinishedMessage:void 0},initialMessage:e.body.ignore?void 0:e,callback:e.callback,authenticated:!1,dataObjectURL:e.dataObjectURL}}},{key:"_secondsSinceEpoch",value:function(){return Math.floor(Date.now()/1e3)}},{key:"_parseMessageURL",value:function(e){var t=e.split("/");return t.length<=6?t[0]+"//"+t[2]+"/"+t[3]:t[0]+"//"+t[2]+"/"+t[3]+"/"+t[4]}},{key:"messageBus",get:function(){return this._messageBus},set:function(e){var t=this;t._messageBus=e,t.addGUIListeners()}},{key:"coreDiscovery",get:function(){return this._coreDiscovery},set:function(e){this._coreDiscovery=e}},{key:"registry",get:function(){return this._registry},set:function(e){this._registry=e}}]),IdentityModule}();/*
...
//}
t.default=P,e.exports=t.default},/* 466 */
/***/
...
/***/
function(e,t,r){"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var n=r(12),i=_interopRequireDefault(n),o=r(40),a=_interopRequireDefault(o),s=r(41),u=_interopRequireDefault(s),c=r(1),f=_interopRequireDefault(c),l=r(2),d=_interopRequireDefault(l),p=r(468),y=function(){function Crypto(e){(0,f.default)(this,Crypto);var t=this;"function"==typeof e.createWebcrypto?t._crypto=e.createWebcrypto():t._crypto=crypto,t.cryptoUTF8Encoder=p.encodeUTF8,t.cryptoUTF8Decoder=p.decodeUTF8}/**
  * encode a byteArray value in base 64 encode
  * @param   {byteArray}    value    byteArray value
  * @return  {string}   encoded value
  */
return(0,d.default)(Crypto,[{key:"encode",value:function(e){return btoa((0,u.default)(e))}},{key:"decode",value:function(e){
//    CLog('Before dec val', value);
try{return JSON.parse(atob(e))}catch(e){throw e}}},{key:"decodeToUint8Array",value:function(e){try{var t=void 0;
//TODO: The verification if the string contains the \" mutch be checked since it might fail
if(atob(e).indexOf('"')>-1){var r=JSON.parse(atob(e));t=(0,a.default)(r).map(function(e){return r[e]})}else t=JSON.parse("["+atob(e)+"]");return new Uint8Array(t)}catch(e){throw e}}},{key:"encryptRSA",value:function(e,t){var r=this;return new i.default(function(n,i){r._importRSAencryptKey(new Uint8Array(e)).then(function(e){r._crypto.subtle.encrypt({name:"RSA-OAEP"},e,//from generateKey or importKey above
t).then(function(e){
//returns an ArrayBuffer containing the encrypted data
// CLog('crypto-encryptRSA', new Uint8Array(encrypted));
n(new Uint8Array(e))}).catch(function(e){
// CLog('crypto-encryptRSA', err);
i(e)})})})}},{key:"decryptRSA",value:function(e,t){var r=this;return new i.default(function(n,i){r._importRSAdecryptKey(e).then(function(e){r._crypto.subtle.decrypt({name:"RSA-OAEP"},e,//from generateKey or importKey above
...
i(e)})})})}},{key:"signRSA",value:function(e,t){var r=this;return new i.default(function(n,i){r._importRSAsignKey(e).then(function(e){
//CLog('TIAGO: signRSA data', data);
r._crypto.subtle.sign({name:"RSASSA-PKCS1-v1_5"},e,//from generateKey or importKey above
r._utf8Encode(t)).then(function(e){
//returns an ArrayBuffer containing the signature
// CLog('crypto-signRSA', new Uint8Array(signature));
n(new Uint8Array(e))}).catch(function(e){
// CLog('crypto-signRSA', err);
i(e)})})})}},{key:"verifyRSA",value:function(e,t,r){var n=this;return new i.default(function(i,o){n._importRSAverifyKey(e).then(function(e){
//CLog('TIAGO: verifyRSA data', data);
n._crypto.subtle.verify({name:"RSASSA-PKCS1-v1_5"},e,//from generateKey or importKey above
...
o(e)})})})}},{key:"encryptAES",value:function(e,t,r){var n=this;return new i.default(function(i,o){n._importAESkey(e).then(function(e){
//CLog('TIAGO: encryptAES data', data);
n._crypto.subtle.encrypt({name:"AES-CBC",
...
o(e)})})})}},{key:"decryptAES",value:function(e,t,r){var n=this;return new i.default(function(i,o){n._importAESkey(e).then(function(e){n._crypto.subtle.decrypt({name:"AES-CBC",iv:r},e,//from generateKey or importKey above
t).then(function(e){var t=n._utf8Decode(new Uint8Array(e));i(t)}).catch(function(e){
// CLog('crypto-decryptAES', err);
o(e)})})})}},{key:"hashHMAC",value:function(e,t){var r=this;return new i.default(function(n,i){"string"!=typeof t&&(t=(0,u.default)(t)),r._importHMACkey(e).then(function(e){r._crypto.subtle.sign({name:"HMAC"},e,//from generateKey or importKey above
r._utf8Encode(t)).then(function(e){new Uint8Array(e),
// CLog('crypto-hashHMAC', signature);
//returns an ArrayBuffer containing the signature
n(new Uint8Array(e))}).catch(function(e){
// CLog('crypto-hashHMAC', err);
i(e)})})})}},{key:"verifyHMAC",value:function(e,t,r){var n=this;return new i.default(function(i,o){n._importHMACkey(e).then(function(e){"string"!=typeof t&&(t=(0,u.default)(t)),
//CLog('TIAGO: verifyHMAC data', data);
n._crypto.subtle.verify({name:"HMAC"},e,//from generateKey or importKey above
r,//ArrayBuffer of the signature
n._utf8Encode(t)).then(function(e){e?i(e):o(e)}).catch(function(e){o(e)})})})}},{key:"generateRSAKeyPair",value:function(){var e=this,t={};return new i.default(function(r,n){e._crypto.subtle.generateKey({name:"RSA-PSS",modulusLength:2048,//can be 1024, 2048, or 4096
...
r(t)}).catch(function(e){n(e)})}).catch(function(e){n(e)})})}},{key:"generateIV",value:function(){var e=this,t=new Uint8Array(16);return e._crypto.getRandomValues(t),t}},{key:"generateRandom",value:function(){var e=this,t=new Uint8Array(32);e._crypto.getRandomValues(t);
// add in the first 4 bytes of the array the bytes extracted previously;
for(var r=Date.now(),n=e._utf8Encode(r.toString()),i=n.slice(n.length-4,n.length),o=0;o<4;o++)t[o]=i[o];return t}},{key:"generatePMS",value:function(){var e=this,t=new Uint8Array(48);return e._crypto.getRandomValues(t),t}},{key:"generateMasterSecret",value:function(e,t){var r=this;return new i.default(function(n,i){var o=new Uint8Array(48),a=t;r._digest(e).then(function(e){r.hashHMAC(e,a).then(function(t){
...
i(e)})})}},{key:"_importRSAsignKey",value:function(e){var t=this;return new i.default(function(r,n){t._crypto.subtle.importKey("pkcs8",//can be 'jwk' (public or private), 'spki' (public only), or 'pkcs8' (private only)
...
r(e)}).catch(function(e){n(e)})})}},{key:"_importRSAverifyKey",value:function(e){var t=this;return new i.default(function(r,n){t._crypto.subtle.importKey("spki",//can be 'jwk' (public or private), 'spki' (public only), or 'pkcs8' (private only)
e,{//these are the algorithm options
name:"RSASSA-PKCS1-v1_5",hash:{name:"SHA-256"}},!0,//whether the key is extractable (i.e. can be used in exportKey)
["verify"]).then(function(e){
//returns a publicKey (or privateKey if you are importing a private key)
// CLog('crypto-_importRSAverifyKey', publicKey);
r(e)}).catch(function(e){n(e)})})}},{key:"_importRSAencryptKey",value:function(e){var t=this;return new i.default(function(r,n){t._crypto.subtle.importKey("spki",//can be 'jwk' (public or private), 'spki' (public only), or 'pkcs8' (private only)
e,{//these are the algorithm options
...
r(e)}).catch(function(e){n(e)})})})}},{key:"_digest",value:function(e){var t=this;return new i.default(function(r,n){t._crypto.subtle.digest({name:"SHA-256"},e).then(function(e){
//returns the hash as an ArrayBuffer
// CLog('crypto-digest', new Uint8Array(hash));
r(new Uint8Array(e))}).catch(function(e){n(e)})})}},{key:"_importAESkey",value:function(e){var t=this;return new i.default(function(r,n){t._crypto.subtle.importKey("raw",//can be 'jwk' or 'raw'
e,{//this is the algorithm options
...
r(e)}).catch(function(e){n(e)})})}},{key:"_utf8Encode",value:function(e){return this.cryptoUTF8Encoder(e)}},{key:"_utf8Decode",value:function(e){return this.cryptoUTF8Decoder(e)}}]),Crypto}();t.default=y,e.exports=t.default},/* 468 */
/***/
function(e,t,r){"use strict";
...
"wait"===e.body.value?setTimeout(function(){r._messageBus.postMessage(o)},r._waitTime):r._messageBus.postMessage(o)}})};t.default=o,e.exports=t.default},/* 470 */
/***/
function(e,t,r){"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var n=r(12),i=_interopRequireDefault(n),o=r(1),a=_interopRequireDefault(o),s=r(2),u=_interopRequireDefault(s),c=r(11),f=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t}(c),l=r(471),d=_interopRequireDefault(l),p=r(472),y=_interopRequireDefault(p),h=r(473),v=_interopRequireDefault(h),g=r(15),b=f.getLogger("PEP"),m=function(){/**
...
return(0,y.default)(SubscriptionCondition,e),(0,u.default)(SubscriptionCondition,[{key:"isApplicable",value:function(e,t){return!!("subscribe"===t.type&e.isFromRemoteSM(t.from))&&(0,d.default)(SubscriptionCondition.prototype.__proto__||(0,i.default)(SubscriptionCondition.prototype),"isApplicable",this).call(this,e,t)}}]),SubscriptionCondition}(v.default);/**
                        ...
                        * limitations under the License.
                        **/
t.default=g,e.exports=t.default},/* 477 */
/***/
function(e,t,r){"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}t.__esModule=!0;var n=r(60),i=_interopRequireDefault(n),o=r(478),a=_interopRequireDefault(o);t.default=function get(e,t,r){null===e&&(e=Function.prototype);var n=(0,a.default)(e,t);if(void 0===n){var o=(0,i.default)(e);return null===o?void 0:get(o,t,r)}if("value"in n)return n.value;var s=n.get;if(void 0!==s)return s.call(r)}},/* 478 */
/***/
function(e,t,r){e.exports={default:r(479),__esModule:!0}},/* 479 */
/***/
function(e,t,r){r(480);var n=r(13).Object;e.exports=function(e,t){return n.getOwnPropertyDescriptor(e,t)}},/* 480 */
/***/
function(e,t,r){
// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
var n=r(46),i=r(141).f;r(97)("getOwnPropertyDescriptor",function(){return function(e,t){return i(n(e),t)}})},/* 481 */
/***/
function(e,t,r){"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(t,"__esModule",{value:!0});var n=r(41),i=_interopRequireDefault(n),o=r(60),a=_interopRequireDefault(o),s=r(1),u=_interopRequireDefault(s),c=r(2),f=_interopRequireDefault(c),l=r(68),d=_interopRequireDefault(l),p=r(69),y=_interopRequireDefault(p),h=r(11),v=function(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]=e[r]);return t.default=e,t}(h),g=r(200),b=_interopRequireDefault(g),m=r(482),_=_interopRequireDefault(m),R=v.getLogger("MessageBus"),w=function(e){/* private
  _registry: Registry
...
t._registry.resolve(e).then(function(r,n){n?t.forward(r,n):t.forward(r,e)}).catch(function(e){R.error("RESOLVE-ERROR: ",e)})}},{key:"pipeline",get:function(){return this._pipeline}}]),MessageBus}(b.default);t.default=w,e.exports=t.default},/* 482 */
/***/
...
value:function(){var e=this;e._inStop||(e._iter.hasNext?e._iter.next(e):e._onDeliver(e._msg))}},{key:"deliver",value:function(){var e=this;e._inStop||(e._inStop=!0,e._onDeliver(e._msg))}},{key:"fail",value:function(e){var t=this;t._inStop||(t._inStop=!0,t._pipeline.onFail&&t._pipeline.onFail(e))}},{key:"pipeline",get:function(){return this._pipeline}},{key:"msg",get:function(){return this._msg},set:function(e){this._msg=e}}]),PipeContext}(),c=function(){/* private
    ...
    _array: []
  */
function Iterator(e){(0,i.default)(this,Iterator),this._index=-1,this._array=e}return(0,a.default)(Iterator,[{key:"hasNext",get:function(){return this._index<this._array.length-1}},{key:"next",get:function(){return this._index++,this._array[this._index]}}]),Iterator}();t.default=s,e.exports=t.default},/* 483 */
/***/
 ...
 */
e.exports=t.default},/* 487 */
/***/
function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=r(1),i=function(e){return e&&e.__esModule?e:{default:e}}(n),o=function GraphConnector(e,t,r){(0,i.default)(this,GraphConnector)};t.default=o,e.exports=t.default},/* 488 */
/***/
...
/***/
function(e,t,r){e.exports={default:r(491),__esModule:!0}},/* 491 */
/***/
function(e,t,r){r(126),r(492),e.exports=r(13).Array.from},/* 492 */
/***/
function(e,t,r){"use strict";var n=r(65),i=r(26),o=r(76),a=r(189),s=r(190),u=r(132),c=r(493),f=r(191);i(i.S+i.F*!r(196)(function(e){Array.from(e)}),"Array",{
// 22.1.2.1 Array.from(arrayLike, mapfn = undefined, thisArg = undefined)
from:function(e){var t,r,i,l,d=o(e),p="function"==typeof this?this:Array,y=arguments.length,h=y>1?arguments[1]:void 0,v=void 0!==h,g=0,b=f(d);
// if object isn't iterable or it's array with default iterator - use simple case
if(v&&(h=n(h,y>2?arguments[2]:void 0,2)),void 0==b||p==Array&&s(b))for(t=u(d.length),r=new p(t);t>g;g++)c(r,g,v?h(d[g],g):d[g]);else for(l=b.call(d),r=new p;!(i=l.next()).done;g++)c(r,g,v?a(l,h,[i.value,g],!0):i.value);return r.length=g,r}})},/* 493 */
/***/
function(e,t,r){"use strict";var n=r(38),i=r(73);e.exports=function(e,t,r){t in e?n.f(e,t,i(0,r)):e[t]=r}},/* 494 */
/***/
...
delete t._observers[r])}},{key:"url",get:function(){return this._url}}]),SyncherManager}();t.default=O,e.exports=t.default},/* 496 */
/***/
function(e,t,r){r(497),e.exports=r(13).Object.values},/* 497 */
/***/
function(e,t,r){
// https://github.com/tc39/proposal-object-values-entries
var n=r(26),i=r(498)(!1);n(n.S,"Object",{values:function(e){return i(e)}})},/* 498 */
/***/
function(e,t,r){var n=r(67),i=r(46),o=r(77).f;e.exports=function(e){return function(t){for(var r,a=i(t),s=n(a),u=s.length,c=0,f=[];u>c;)o.call(a,r=s[c++])&&f.push(e?[r,a[r]]:a[r]);return f}}},/* 499 */
/***/
...
a.errors.forEach(function(e){delete e.stack}),!a.valid||a.missing.length}catch(e){}}Object.defineProperty(t,"__esModule",{value:!0});var n=r(41);_interopRequireDefault(n);t.schemaValidation=schemaValidation;var i=r(500),o=_interopRequireDefault(i)},/* 500 */
/***/
...
// Non-standard validation options
UNKNOWN_PROPERTY:"Unknown property (not in schema)"};ValidationError.prototype=(0,f.default)(Error.prototype),ValidationError.prototype.constructor=ValidationError,ValidationError.prototype.name="ValidationError",ValidationError.prototype.prefixWith=function(e,t){if(null!==e&&(e=e.replace(/~/g,"~0").replace(/\//g,"~1"),this.dataPath="/"+e+this.dataPath),null!==t&&(t=t.replace(/~/g,"~0").replace(/\//g,"~1"),this.schemaPath="/"+t+this.schemaPath),null!==this.subErrors)for(var r=0;r<this.subErrors.length;r++)this.subErrors[r].prefixWith(e,t);return this};var O={},M=createApi();M.addLanguage("en-gb",S),
//legacy property
M.tv4=M,
//return tv4;
t.default=M,
//}
e.exports=t.default},/* 501 */
/***/
function(e,t,r){e.exports={default:r(502),__esModule:!0}},/* 502 */
/***/
function(e,t,r){r(503),e.exports=r(13).Object.isFrozen},/* 503 */
/***/
function(e,t,r){
// 19.1.2.12 Object.isFrozen(O)
var n=r(44);r(97)("isFrozen",function(e){return function(t){return!n(t)||!!e&&e(t)}})},/* 504 */
/***/
...
//    return resolve(message);
//  } else {
if(t){"subscribe"===e.type&i.isFromRemoteSM(e.from)?
