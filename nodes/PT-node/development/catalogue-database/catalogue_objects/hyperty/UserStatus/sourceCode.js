...
var UserStatus = function (_EventEmitter) {
  ...
  function UserStatus(hypertyURL, bus, configuration) {
    ...
    _this._discovery = new _Discovery2.default(hypertyURL, bus);
      ...
      return new Promise(function (resolve, reject) {
        ...
        userList.forEach(function (user) {
          ...
          if (user.email.length) {
            console.info('------------------------ _mappingUser ----------------------', userList);
            return _this6._discovery.discoverHypertyPerUser(user.email, user.domain).then(activeUsers).catch(inactiveUsers);
          }
        });
      });
    }
...
},{"../utils/EventEmitter.js":9,"./availability.js":8,"service-framework/dist/Discovery":1,"service-framework/dist/Syncher":2,"urijs":5}],8:[function(require,module,exports){
"use strict";
